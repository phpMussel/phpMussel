...
$phpMussel['lang']['config_PHPMailer_Enable2FA'] = 'ซึ่งจะกำหนดว่าบัญชีส่วนหน้าควรใช้ 2FA หรือไม่.';
$phpMussel['lang']['config_PHPMailer_EventLog'] = 'ไฟล์สำหรับบันทึกเหตุการณ์ทั้งหมดที่เกี่ยวข้องกับ PHPMailer. ระบุชื่อไฟล์หรือเว้นว่างไว้เพื่อปิดใช้งาน.';
$phpMussel['lang']['config_PHPMailer_Host'] = 'โฮสต์ SMTP ที่ใช้สำหรับอีเมลขาออก.';
$phpMussel['lang']['config_PHPMailer_Password'] = 'รหัสผ่านสำหรับเมื่อส่งอีเมล.';
$phpMussel['lang']['config_PHPMailer_Port'] = 'หมายเลขพอร์ตที่จะใช้สำหรับอีเมลขาออก. ค่าเริ่มต้น = 587.';
$phpMussel['lang']['config_PHPMailer_SMTPAuth'] = 'กำหนดว่าเซสชัน SMTP ควรได้รับการตรวจสอบสิทธิ์หรือไม่ (ควรปล่อยให้อยู่คนเดียว).';
$phpMussel['lang']['config_PHPMailer_SMTPSecure'] = 'โปรโตคอลสำหรับการส่งอีเมล (TLS หรือ SSL).';
...
$phpMussel['lang']['config_PHPMailer_Username'] = 'ชื่อผู้ใช้สำหรับเมื่อส่งอีเมล.';
$phpMussel['lang']['config_PHPMailer_addReplyToAddress'] = 'ที่อยู่ตอบกลับสำหรับเมื่อส่งอีเมล.';
$phpMussel['lang']['config_PHPMailer_addReplyToName'] = 'ชื่อตอบกลับสำหรับเมื่อส่งอีเมล.';
$phpMussel['lang']['config_PHPMailer_setFromAddress'] = 'ที่อยู่ผู้ส่งสำหรับเมื่อส่งอีเมล.';
$phpMussel['lang']['config_PHPMailer_setFromName'] = 'ชื่อผู้ส่งสำหรับเมื่อส่งอีเมล.';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'พยายามปิดกั้นไฟล์ใด ๆ ที่มีแมโคร? เอกสารและสเปรดชีตบางประเภทอาจมีแมโครปฏิบัติการได้. นี่อาจเป็นเวกเตอร์ที่เป็นไปได้สำหรับมัลแวร์. False = อย่าปิดกั้น [ค่าเริ่มต้น]; True = ปิดกั้น.';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'รายการส่วนขยายไฟล์อนุญาตให้มีโค้ด PHP คั่นด้วยเครื่องหมายจุลภาค. ถ้าการตรวจจับการโจมตีของกิ้งก่า PHP ถูกเปิดใช้งาน ไฟล์ที่มีโค้ด PHP ซึ่งมีส่วนขยายที่ไม่ได้อยู่ในรายการนี้จะถูกตรวจพบว่าเป็น PHP กิ้งก่าโจมตี.';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'ตรวจหาส่วนหัวที่ไม่ถูกต้องในที่เก็บถาวรและไฟล์บีบอัด. ได้รับการสนับสนุน: BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP. False = ปิดใช้งาน; True = เปิดใช้งาน.';
...
$phpMussel['lang']['config_experimental'] = 'ไม่เสถียร/ทดลอง!';
...
$phpMussel['lang']['config_files_check_archives'] = 'พยายามตรวจสอบเนื้อหาของเก็บถาวรหรือไม่? False = ไม่ตรวจสอบ; True = ตรวจสอบ [ค่าเริ่มต้น].';
...
$phpMussel['lang']['config_files_max_recursion'] = 'ความลึกสูงสุดของการเรียกซ้ำสำหรับเก็บถาวร. ค่าเริ่มต้น = 3.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'หยุดใช้ webfonts หรือไม่? True = หยุดใช้ [ค่าเริ่มต้น]; False = ไม่หยุดใช้.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'จำนวนไฟล์สูงสุดที่สามารถอยู่ในเขตกักกัน. เมื่อมีการเพิ่มไฟล์ใหม่ลงในเขตกักกัน ถ้าเกินจำนวนนี้ ไฟล์เก่าจะถูกลบจนกว่าส่วนที่เหลือจะไม่เกินจำนวนนี้. ค่าเริ่มต้น = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'ที่อยู่ของนโยบายความเป็นส่วนตัวที่เกี่ยวข้องเพื่อแสดงในส่วนท้ายของหน้าเว็บที่สร้างขึ้น. ระบุ URL หรือเว้นว่างไว้เพื่อปิดใช้งาน.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymise IP addresses เมื่อเขียนล็อกไฟล์หรือไม่? True = ทำ [ค่าเริ่มต้น]; False = ไม่ทำ.';
...
$phpMussel['lang']['confirm_action'] = 'คุณแน่ใจหรือไม่ว่าต้องการ "%s"?';
$phpMussel['lang']['field_2fa'] = 'โค้ด 2FA';
...
$phpMussel['lang']['field_confirm'] = 'ยืนยัน';
...
$phpMussel['lang']['label_fmgr_other_sig'] = 'กฎและไฟล์ลายเซ็นอื่น ๆ, ฯลฯ';
$phpMussel['lang']['label_fmgr_safety'] = 'กลไกความปลอดภัย';
...
$phpMussel['lang']['link_siginfo'] = 'ข้อมูลลายเซ็น';
...
$phpMussel['lang']['response_2fa_invalid'] = 'ป้อนรหัส 2FA ไม่ถูกต้อง รับรองความถูกต้องล้มเหลว.';
$phpMussel['lang']['response_2fa_valid'] = 'การตรวจสอบสิทธิ์ทำสำเร็จแล้ว.';
...
$phpMussel['lang']['siginfo_key_Fake'] = 'ตรวจจับการปลอมแปลงที่เป็นอันตราย (ซอฟต์แวร์ สคริปต์ ฯลฯ).';
$phpMussel['lang']['siginfo_key_HEUR'] = 'ลายเซ็นที่ได้จากข้อมูล heuristic.';
$phpMussel['lang']['siginfo_key_META'] = 'ลายเซ็นที่ทำงานกับข้อมูลเมตาของไฟล์ (ไม่ใช่ข้อมูลไฟล์),';
$phpMussel['lang']['siginfo_key_Other'] = 'ไม่ปรากฏชื่อหรืออื่น ๆ.';
$phpMussel['lang']['siginfo_key_Other_Metadata'] = 'ไม่มีข้อมูลเมตา.';
$phpMussel['lang']['siginfo_key_Suspect'] = 'การตรวจจับเป็นสิ่งที่น่าสงสัย แต่ไม่ได้รับการยืนยัน (อาจเกี่ยวข้องกับการรวมตัวระบุ).';
$phpMussel['lang']['siginfo_key_Testfile'] = 'ลายเซ็นสำหรับไฟล์ทดสอบ (เหล่านี้ไม่ได้เป็นอันตราย).';
$phpMussel['lang']['siginfo_key_Total'] = 'ลายเซ็นที่ใช้งานอยู่ทั้งหมด.';
$phpMussel['lang']['siginfo_key_VT'] = 'ลายเซ็นรวมหรืออิงจากข้อมูลจาก Virus Total.';
$phpMussel['lang']['siginfo_key_Werewolf'] = 'ลายเซ็นที่จัดการกับ "werewolf โจมตี".';
$phpMussel['lang']['siginfo_sub_Classes'] = 'นับตามคลาสไฟล์ลายเซ็น';
$phpMussel['lang']['siginfo_sub_Files'] = 'นับโดยไฟล์ลายเซ็น';
$phpMussel['lang']['siginfo_sub_MalwareTypes'] = 'นับตามชนิดของการติดเชื้อหรือมัลแวร์';
$phpMussel['lang']['siginfo_sub_SigTypes'] = 'นับด้วยข้อมูลเมตาที่เป็นลายเซ็น';
$phpMussel['lang']['siginfo_sub_Targets'] = 'นับด้วยเวกเตอร์ที่กำหนดเป้าหมาย';
$phpMussel['lang']['siginfo_sub_Vendors'] = 'นับโดยผู้ขายหรือแหล่งที่มาของลายเซ็น';
$phpMussel['lang']['siginfo_xkey'] = 'ระบุว่า "%s".';
$phpMussel['lang']['state_async_deny'] = 'สิทธิ์ไม่เพียงพอที่จะดำเนินการคำขอแบบอะซิงโครนัส. ลองเข้าสู่ระบบอีกครั้ง.';
$phpMussel['lang']['state_cache_is_empty'] = 'แคชว่างเปล่า.';
...
$phpMussel['lang']['state_email_sent'] = 'ส่งอีเมลสำเร็จ "%s" แล้ว.';
$phpMussel['lang']['state_failed_missing'] = 'ภารกิจล้มเหลวเนื่องจากคอมโพเนนต์ที่จำเป็นไม่พร้อมใช้งาน.';
...
$phpMussel['lang']['state_logged_in_2fa_pending'] = 'เข้าสู่ระบบ + รอดำเนินการ 2FA.';
$phpMussel['lang']['state_logged_out'] = 'ออกจากระบบ.';
...
$phpMussel['lang']['tip_2fa_sent'] = 'อีเมลที่มีรหัส 2FA ถูกส่งไปยังที่อยู่อีเมลของคุณแล้ว.โปรดยืนยันรหัสนี้ด้านล่างเพื่อเข้าถึง front-end. หากคุณไม่ได้รับอีเมลนี้ ลองออกจากระบบ รอ 10 นาที และลงชื่อเข้าใช้อีกครั้งเพื่อรับอีเมลใหม่ที่มีรหัสใหม่.';
...
$phpMussel['lang']['tip_cache_data'] = 'สวัสดี {username}.<br />ที่นี่คุณสามารถตรวจสอบเนื้อหาของแคชได้.';
...
$phpMussel['lang']['tip_pie_html'] = 'คลิกที่ชื่อองค์ประกอบเพื่อดูรายละเอียดเพิ่มเติม.';
...
$phpMussel['lang']['tip_siginfo'] = 'สวัสดี {username}.<br />หน้าข้อมูลลายเซ็นให้ข้อมูลเบื้องต้นเกี่ยวกับแหล่งที่มาและประเภทของลายเซ็นที่ใช้งานอยู่ในปัจจุบัน.';
...
$phpMussel['lang']['title_login'] = 'เข้าสู่ระบบ';
...
<br />
รหัส 2FA ของคุณสำหรับการลงชื่อเข้าใช้ phpMussel front-end:</p>
<h1>%2$s</h1>
