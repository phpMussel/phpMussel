 ...
 * @see LICENSE.txt
 *
 * This file: Spanish language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Construido dentro phpMussel es un URL escáner, capaz de detectar las maliciosas URL desde el interior de los datos o archivos escaneados. Para activar la URL escáner, definir `urlscanner` como true; Para desactivarlo, definir esta directiva como false.';
