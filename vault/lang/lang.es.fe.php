 ...
 * @see LICENSE.txt
 *
 * This file: Spanish language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_signatures_MD5'] = 'Cotejar contra MD5 firmas cuando escaneando? Si es así, especifique los nombres de los archivos de firmas a utilizar, delimitado por comas.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Cotejar PE (Portátil Ejecutable) archivos (EXE, DLL, etc) con PE extendidas firmas cuando escaneando? Si es así, especifique los nombres de los archivos de firmas a utilizar, delimitado por comas.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Cotejar PE (Portátil Ejecutable) archivos (EXE, DLL, etc) con PE Secciónal firmas cuando escaneando? Si es así, especifique los nombres de los archivos de firmas a utilizar, delimitado por comas.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Construido dentro phpMussel es un URL escáner, capaz de detectar las maliciosas URL desde el interior de los datos o archivos escaneados. Para activar la URL escáner, especifique los nombres de los archivos de firmas a utilizar, delimitado por comas.';
...
$phpMussel['lang']['tip_see_the_documentation'] = 'Ver la <a href="https://github.com/Maikuolan/phpMussel/blob/master/_docs/readme.es.md#SECTION7">documentación</a> para obtener información sobre las distintas directivas de la configuración y sus propósitos.';
...
$phpMussel['lang']['info_some_useful_links'] = 'Algunos enlaces útiles:<ul>
            <li><a href="https://github.com/Maikuolan/phpMussel/issues">phpMussel Issues @ GitHub</a> – Página de problemas para phpMussel (apoyo, asistencia, etc).</li>
            ...
            <li><a href="http://www.clamav.net/">ClamavNet</a> – Página principal de ClamAV (ClamAV® es un motor antivirus de código abierto para detectar troyanos, virus, malware y otras amenazas maliciosas).</li>
