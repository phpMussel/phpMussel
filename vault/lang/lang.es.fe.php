...
$phpMussel['lang']['config_PHPMailer_Enable2FA'] = 'Esta directiva determina si se debe usar 2FA para las cuentas del front-end.';
$phpMussel['lang']['config_PHPMailer_EventLog'] = 'Un archivo para registrar todos los eventos en relación con PHPMailer. Especificar el nombre del archivo, o dejar en blanco para desactivar.';
$phpMussel['lang']['config_PHPMailer_Host'] = 'El host SMTP para usar para el correo electrónico saliente.';
$phpMussel['lang']['config_PHPMailer_Password'] = 'La contraseña a usar cuando se envía un correo electrónico a través de SMTP.';
$phpMussel['lang']['config_PHPMailer_Port'] = 'El número de puerto a usar para el correo electrónico saliente. Predefinido = 587.';
$phpMussel['lang']['config_PHPMailer_SMTPAuth'] = 'Esta directiva determina si autenticar sesiones SMTP (generalmente debería dejarse solo).';
$phpMussel['lang']['config_PHPMailer_SMTPSecure'] = 'El protocolo a usar cuando se envía un correo electrónico a través de SMTP (TLS o SSL).';
...
$phpMussel['lang']['config_PHPMailer_Username'] = 'El nombre de usuario a usar cuando se envía un correo electrónico a través de SMTP.';
$phpMussel['lang']['config_PHPMailer_addReplyToAddress'] = 'La dirección de la respuesta para citar cuando se envía un correo electrónico a través de SMTP.';
$phpMussel['lang']['config_PHPMailer_addReplyToName'] = 'El nombre de la respuesta para citar cuando se envía un correo electrónico a través de SMTP.';
$phpMussel['lang']['config_PHPMailer_setFromAddress'] = 'La dirección del remitente para citar cuando se envía un correo electrónico a través de SMTP.';
$phpMussel['lang']['config_PHPMailer_setFromName'] = 'El nombre del remitente para citar cuando se envía un correo electrónico a través de SMTP.';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = '¿Intenta bloquear cualquier archivo que contenga macros? Algunos tipos de documentos y hojas de cálculo pueden contener macros ejecutables, proporcionando así un peligroso vector de malware potencial. False = No bloquear [Predefinido]; True = Bloquear.';
...
$phpMussel['lang']['config_files_max_recursion'] = 'Máximo recursividad nivel límite para compactados archivos. Predefinido = 3.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = '¿Desactivar webfonts? True = Sí [Predefinido]; False = No.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'La cantidad máxima de archivos que pueden existir en la cuarentena. Cuando se agregan nuevos archivos a la cuarentena, si se excede este número, los archivos antiguos se eliminarán hasta que el resto ya no exceda este número. Predefinido = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'La dirección de una política de privacidad relevante que se mostrará en el pie de página de cualquier página generada. Especificar una URL, o dejar en blanco para desactivar.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = '¿Seudonimizar las direcciones IP cuando al escribir archivos de registro? True = Sí [Predefinido]; False = No.';
...
$phpMussel['lang']['confirm_action'] = '¿Estás seguro de que quieres "%s"?';
...
$phpMussel['lang']['field_verify'] = 'Verificar';
$phpMussel['lang']['field_verify_all'] = 'Verificar todo';
...
$phpMussel['lang']['label_fmgr_other_sig'] = 'Otras reglas, archivos de firmas, etc';
$phpMussel['lang']['label_fmgr_safety'] = 'Mecanismos de seguridad';
...
$phpMussel['lang']['label_your_ip'] = 'Tu IP:';
$phpMussel['lang']['label_your_ua'] = 'Tu UA:';
$phpMussel['lang']['link_accounts'] = 'Cuentas';
$phpMussel['lang']['link_cache_data'] = 'Datos de Caché';
...
$phpMussel['lang']['link_siginfo'] = 'Información de Firmas';
...
$phpMussel['lang']['siginfo_key_Fake'] = 'Las detecciones son variantes falsas y maliciosas de entidades benignas (software, scripts, etc).';
$phpMussel['lang']['siginfo_key_HEUR'] = 'Firmas derivadas de datos heurísticos.';
$phpMussel['lang']['siginfo_key_META'] = 'Firmas que trabajan con metadatos de archivos (a diferencia de los datos de archivos).';
$phpMussel['lang']['siginfo_key_Other'] = 'No identificado u otro.';
$phpMussel['lang']['siginfo_key_Other_Metadata'] = 'No hay metadatos disponibles.';
$phpMussel['lang']['siginfo_key_Suspect'] = 'Las detecciones son sospechosas, pero no confirmadas (pueden implicar combinaciones de varios identificadores).';
$phpMussel['lang']['siginfo_key_Testfile'] = 'Firmas para archivos de prueba (es decir, no detecciones maliciosas).';
$phpMussel['lang']['siginfo_key_Total'] = 'Firmas activas totales.';
$phpMussel['lang']['siginfo_key_VT'] = 'Firmas que incluyen o se basan en datos de Virus Total.';
$phpMussel['lang']['siginfo_key_Werewolf'] = 'Firmas que se ocupan de "ataques de werewolf".';
$phpMussel['lang']['siginfo_sub_Classes'] = 'Cuenta por clase de archivo de firma';
$phpMussel['lang']['siginfo_sub_Files'] = 'Cuenta por archivo de firma';
$phpMussel['lang']['siginfo_sub_MalwareTypes'] = 'Cuente por infección o tipo de malware';
$phpMussel['lang']['siginfo_sub_SigTypes'] = 'Cuenta por metadatos de firma';
$phpMussel['lang']['siginfo_sub_Targets'] = 'Cuenta por vector objetivo';
$phpMussel['lang']['siginfo_sub_Vendors'] = 'Cuenta por proveedor o fuente de firma';
...
$phpMussel['lang']['state_cache_is_empty'] = 'El caché está vacío.';
...
$phpMussel['lang']['state_email_sent'] = 'Correo electrónico enviado con éxito a "%s".';
$phpMussel['lang']['state_failed_missing'] = 'La tarea falló porque un componente necesario no está disponible.';
...
$phpMussel['lang']['state_logged_in_2fa_pending'] = 'Conectado + 2FA pendiente.';
...
$phpMussel['lang']['tip_fe_cookie_warning'] = 'Nota: phpMussel usa una cookie para autenticar los inicios de sesión. Al iniciar sesión, usted da su consentimiento para que su navegador cree y almacene una cookie.';
...
$phpMussel['lang']['tip_pie_html'] = 'Haga clic en el nombre del componente para más detalles.';
...
$phpMussel['lang']['tip_siginfo'] = 'Hola, {username}.<br />La página de información de firmas proporciona información básica sobre las fuentes y los tipos de las firmas activas actualmente.';
