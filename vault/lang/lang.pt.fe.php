 ...
 * @see LICENSE.txt
 *
 * This file: Portuguese language data for the front-end (last modified: 2016.10.29).
 */
...
$phpMussel['lang']['tip_hello'] = 'Olá, {username}.';
$phpMussel['lang']['tip_login'] = 'Nome de usuário padrão: <span class="txtRd">admin</span> – Senha padrão: <span class="txtRd">password</span>';
$phpMussel['lang']['tip_logs'] = 'Selecionar um arquivo de registro da lista abaixo para visualizar o conteúdo do arquivo de registro.';
