 ...
 * @see LICENSE.txt
 *
 * This file: Portuguese language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_general_quarantine_max_usage'] = 'O máximo uso de memória permitido através do quarentena. Se o total de memória utilizada pelo quarentena atingir este valor, os mais antigos arquivos em quarentena serão apagados até que a total memória utilizada já não atinge este valor. Esta directiva é importante como um meio de torná-lo mais difícil por qualquer potenciais atacante para inundar sua quarentena com indesejados dados potencialmente causando excesso uso de dados no seu hospedagem serviço. O valor é em KB. Padrão =65536 =65536KB =64MB.';
...
$phpMussel['lang']['config_signatures_fail_silently'] = 'Deve phpMussel reportar quando os assinaturas arquivos estão perdido ou corrompido? Se `fail_silently` está desativado, perdidos e corrompidos arquivos serão reportado durante análise, e se `fail_silently` está ativado, perdidos e corrompidos arquivos serão ignoradas, com a análise reportando por estes arquivos em que não há problemas. Isso geralmente deve ser deixado sozinho a menos que você está experimentando PHP falhas ou semelhantes problemas. False = Desativado; True = Ativado [Padrão].';
$phpMussel['lang']['config_signatures_MD5'] = 'Verificar contra MD5 assinaturas quando analisando? Nesse caso, especifique os nomes dos arquivos de assinaturas a serem utilizados, delimitados por vírgulas.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Verificar PE (Portátil Executável) arquivos (EXE, DLL, etc) contra PE estendidas assinaturas quando analisando? Nesse caso, especifique os nomes dos arquivos de assinaturas a serem utilizados, delimitados por vírgulas.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Verificar PE (Portátil Executável) arquivos (EXE, DLL, etc) contra PE Seccional assinaturas quando analisando? Nesse caso, especifique os nomes dos arquivos de assinaturas a serem utilizados, delimitados por vírgulas.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Construído em phpMussel é um URL analisador, capaz de detectar URLs maliciosos dentro de todos os dados ou arquivos analisados. Para habilitar o URL analisador, especifique os nomes dos arquivos de assinaturas a serem utilizados, delimitados por vírgulas.';
...
$phpMussel['lang']['tip_see_the_documentation'] = 'Consulte a <a href="https://github.com/Maikuolan/phpMussel/blob/master/_docs/readme.pt.md#SECTION7">documentação</a> para obter informações sobre as várias diretrizes de configuração e seus objetivos.';
...
$phpMussel['lang']['info_some_useful_links'] = 'Alguns links úteis:<ul>
            <li><a href="https://github.com/Maikuolan/phpMussel/issues">phpMussel Issues @ GitHub</a> – Página de problemas para phpMussel (apoio, assistência, etc).</li>
