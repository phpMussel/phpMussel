 ...
 * @see LICENSE.txt
 *
 * This file: Portuguese language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Construído em phpMussel é um URL analisador, capaz de detectar URLs maliciosos dentro de todos os dados ou arquivos analisados. Para habilitar o URL analisador, definir a diretiva `urlscanner` para true; Para desativá-lo, definir esta diretiva para false.';
