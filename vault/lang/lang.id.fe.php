 ...
 * @see LICENSE.txt
 *
 * This file: Indonesian language data for the front-end (last modified: 2018.10.16).
 */
...
$phpMussel['lang']['Extended Description: Chart.js'] = 'Memungkinkan bagian depan untuk menghasilkan bagan pai.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> tersedia melalui <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$phpMussel['lang']['Extended Description: PHPMailer'] = 'Diperlukan untuk menggunakan fungsionalitas apapun yang melibatkan pengiriman email.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> tersedia melalui lisensi <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>.';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'Cobalah untuk memblokir semua file yang mengandung macro? Beberapa jenis dokumen dan spreadsheet mungkin berisi makro yang dapat dijalankan, sehingga menyediakan vektor berbahaya berpotensi. False = Jangan memblokirnya [Default]; True = Memblokirnya.';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'Daftar ekstensi file diperbolehkan untuk berisi kode PHP, dipisahkan oleh koma. Jika deteksi serangan chameleon PHP diaktifkan, file yang berisi kode PHP, yang memiliki ekstensi yang tidak ada dalam daftar ini, akan terdeteksi sebagai serangan chameleon PHP.';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'Mendeteksi header yang salah dalam arsip dan file terkompresi. Didukung: BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP. False = Dinonaktifkan; True = Diaktifkan.';
$phpMussel['lang']['config_attack_specific_chameleon_to_doc'] = 'Cari dokumen office yang header nya tidak benar (Didukung: DOC, DOT, PPS, PPT, XLA, XLS, WIZ). False = Dinonaktifkan; True = Diaktifkan.';
$phpMussel['lang']['config_attack_specific_chameleon_to_img'] = 'Cari gambar yang header nya tidak benar (Didukung: BMP, DIB, PNG, GIF, JPEG, JPG, XCF, PSD, PDD, WEBP). False = Dinonaktifkan; True = Diaktifkan.';
...
$phpMussel['lang']['config_experimental'] = 'Tidak stabil / Eksperimental!';
...
$phpMussel['lang']['config_files_check_archives'] = 'Berusaha mencek isi file terkompress? False = Tidak (Tidak mencek); True = Ya (Mencek) [Default].';
...
$phpMussel['lang']['config_files_max_recursion'] = 'Batas kedalaman rekursi maksimum untuk arsip. Default = 3.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Menonaktifkan webfonts? True = Ya [Default]; False = Tidak.';
...
$phpMussel['lang']['config_general_log_rotation_action'] = 'Rotasi log membatasi jumlah file log yang seharusnya ada pada satu waktu. Ketika file log baru dibuat, jika jumlah total file log melebihi batas yang ditentukan, tindakan yang ditentukan akan dilakukan. Anda dapat menentukan tindakan yang diinginkan disini. Delete = Hapus file log tertua, hingga batasnya tidak lagi terlampaui. Archive = Pertama arsipkan, lalu hapus file log tertua, hingga batasnya tidak lagi terlampaui.';
$phpMussel['lang']['config_general_log_rotation_limit'] = 'Rotasi log membatasi jumlah file log yang seharusnya ada pada satu waktu. Ketika file log baru dibuat, jika jumlah total file log melebihi batas yang ditentukan, tindakan yang ditentukan akan dilakukan. Anda dapat menentukan batas yang diinginkan disini. Nilai 0 akan menonaktifkan rotasi log.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Jumlah maksimum file yang dapat ada di karantina. Ketika file baru ditambahkan ke karantina, jika nomor ini terlampaui, file lama akan dihapus hingga sisanya tidak lagi melebihi nomor ini. Default = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'Alamat dari kebijakan privasi yang relevan untuk ditampilkan di footer dari setiap halaman yang dihasilkan. Spesifikasikan URL, atau biarkan kosong untuk menonaktifkan.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymise alamat IP saat menulis file log? True = Ya; False = Tidak [Default].';
