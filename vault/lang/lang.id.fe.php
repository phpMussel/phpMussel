 ...
 * @see LICENSE.txt
 *
 * This file: Indonesian language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_signatures_MD5'] = 'Cek tanda tangan MD5 ketika pemindaian? Jika demikian, menentukan nama-nama file tanda tangan untuk menggunakan, dipisahkan dengan koma.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Cek file PE (Portable Executable; EXE, DLL, dll) pada tanda tangan PE diperpanjang ketika pemindaian? Jika demikian, menentukan nama-nama file tanda tangan untuk menggunakan, dipisahkan dengan koma.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Cek file PE (Portable Executable; EXE, DLL, dll) pada tanda tangan PE Sectional ketika pemindaian? Jika demikian, menentukan nama-nama file tanda tangan untuk menggunakan, dipisahkan dengan koma.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Dibangun dalam phpMussel adalah scanner URL, mampu mendeteksi URL berbahaya dari dalam data atau file dipindai. Untuk mengaktifkan scanner URL, menset direktif `urlscanner` untuk true; Untuk menonaktifkan, menset direktif ini untuk false.';
