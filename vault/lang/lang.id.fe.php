 ...
 * @see LICENSE.txt
 *
 * This file: Indonesian language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Dibangun dalam phpMussel adalah scanner URL, mampu mendeteksi URL berbahaya dari dalam data atau file dipindai. Untuk mengaktifkan scanner URL, menentukan nama-nama file tanda tangan untuk menggunakan, dipisahkan dengan koma.';
