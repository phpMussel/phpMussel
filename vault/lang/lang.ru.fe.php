 ...
 * @see LICENSE.txt
 *
 * This file: Russian language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'В phpMussel есть URL сканер, способен обнаружить вредоносные URL-адреса изнутри данных или файлов отсканированных. Для активирования URL сканер, то указать имена файлов сигнатур для использования, через запятую.';
