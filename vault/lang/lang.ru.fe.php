...
$phpMussel['lang']['config_general_timeFormat'] = 'Формат нотации даты, используемый phpMussel. Выберите нужный опция из списка ниже. Дополнительные опции могут быть добавлены по запросу.';
