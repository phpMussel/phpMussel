...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'Попробуйте заблокировать любые файлы, содержащие макросы? Некоторые типы документов и таблиц могут содержать исполняемые макросы, что создает опасный потенциальный вредоносный вектор. False = Не блокировать [Стандарт]; True = Блокировать.';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'Список расширений файлов позволяет содержать PHP-код, разделенный запятыми. Если обнаружение атаки хамелеона PHP включено, файлы, содержащие PHP-код, которые имеют расширения, которые не входят в этот список, будут обнаружены как атаки хамелеона PHP.';
...
$phpMussel['lang']['config_experimental'] = 'Нестабильный/Экспериментальный!';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Отключить веб-шрифты? True = Да [Стандарт]; False = Нет.';
...
$phpMussel['lang']['config_general_honeypot_mode'] = 'При активированном Honeypot-модуса phpMussel изолирует каждый загружаемый файл без всякой проверки, не обращая внимание на сигнатуры. Эта функция предназначена исключительно для исследования вирусов и вредоносных программ. Мы рекомендуем использовать эту функцию phpMussel исключительно для «Honeypotting», а не для проверки загружаемых файлов или других целей. В стандартной комплектации эта функция деактивирована. False = Деактивировано [стандартное значение]; True = Активировано.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Максимальное количество файлов, которые могут существовать в карантине. Когда новые файлы добавляются в карантин, если этот номер будет превышен, старые файлы будут удалены до тех пор, пока остаток больше не будет превышать этот номер. Стандарт = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'Адрес соответствующей политики конфиденциальности, отображаемый в нижнем колонтитуле любых сгенерированных страниц. Укажите URL-адрес, или оставьте пустым для отключения.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Псевдонимный IP-адреса при записи файлов журнала? True = Да; False = Нет [Стандарт].';
$phpMussel['lang']['config_signatures_Active'] = 'Список активных файлов сигнатур, разделенных запятыми.';
$phpMussel['lang']['config_signatures_detect_adware'] = 'Интерпретировать сигнатурей для обнаружить рекламное программное? False = Нет; True = Да [Стандарт].';
$phpMussel['lang']['config_signatures_detect_deface'] = 'Интерпретировать сигнатурей для обнаружить дифейсмент/обезображивание программы? False = Нет; True = Да [Стандарт].';
...
$phpMussel['lang']['config_signatures_detect_joke_hoax'] = 'Интерпретировать сигнатурей для обнаружить шутка вредоносные/вирусы программы? False = Нет; True = Да [Стандарт].';
$phpMussel['lang']['config_signatures_detect_packer_packed'] = 'Интерпретировать сигнатурей для обнаружить упаковщики и упакованные данные? False = Нет; True = Да [Стандарт].';
$phpMussel['lang']['config_signatures_detect_pua_pup'] = 'Интерпретировать сигнатурей для обнаружить PUAs/PUPs (потенциально нежелательных программы/приложений)? False = Нет; True = Да [Стандарт].';
$phpMussel['lang']['config_signatures_detect_shell'] = 'Интерпретировать сигнатурей для обнаружить веб-шелл скрипты? False = Нет; True = Да [Стандарт].';
...
$phpMussel['lang']['config_signatures_fail_silently'] = 'Реакция phpMussel на отсутсвие сигнатурей или дефект в них. Когда <code>fail_silently</code> деактивирована, то в течение сканирования будет сообщаться об отсутствии сигнатуры или изъянах в ней. В случае если <code>fail_silently</code> активирована, то отсутствующие или дефектные сигнатуры будут игнорироваться, не сообщая о проблемах. Эта опция должна оставаться такой, если только Вы не ожидаете отказа системы или чего-то подобного. False = Деактивировано; True = Активировано [Стандарт].';
...
$phpMussel['lang']['field_confirm'] = 'Подтвердить';
...
$phpMussel['lang']['link_siginfo'] = 'Информация о Сигнатур';
...
$phpMussel['lang']['response_2fa_invalid'] = 'Введен неправильный код 2FA. Ошибка аутентификации.';
$phpMussel['lang']['response_2fa_valid'] = 'Успешный аутентификации.';
...
$phpMussel['lang']['siginfo_key_Fake'] = 'Обнаруживает поддельные, вредоносные варианты других доброкачественных объектов (программное обеспечение, скрипты, т.д.).';
$phpMussel['lang']['siginfo_key_HEUR'] = 'Сигнатуры, полученные из эвристических данных.';
$phpMussel['lang']['siginfo_key_META'] = 'Сигнатуры, работающие с метаданными файлов (в отличие от данные файлов).';
$phpMussel['lang']['siginfo_key_Other'] = 'Неопознанный или другой.';
$phpMussel['lang']['siginfo_key_Other_Metadata'] = 'Нет доступных метаданных.';
$phpMussel['lang']['siginfo_key_Suspect'] = 'Обнаружения подозреваются, но не подтверждены (могут включать комбинации различных идентификаторов).';
$phpMussel['lang']['siginfo_key_Testfile'] = 'Сигнатуры для тестовых файлов (это доброкачественные).';
$phpMussel['lang']['siginfo_key_Total'] = 'Всего активных сигнатурей.';
$phpMussel['lang']['siginfo_key_VT'] = 'Сигнатуры, в том числе или основанные на данных из Virus Total.';
$phpMussel['lang']['siginfo_key_Werewolf'] = 'Сигнатуры, которые касаются «оборотня атак».';
$phpMussel['lang']['siginfo_sub_Classes'] = 'Подсчет по файлов сигнатуры';
$phpMussel['lang']['siginfo_sub_Files'] = 'Подсчет по файлов сигнатуры';
$phpMussel['lang']['siginfo_sub_MalwareTypes'] = 'Подсчет по инфекция или тип вредоносных программ';
$phpMussel['lang']['siginfo_sub_SigTypes'] = 'Подсчет по метаданных сигнатуры';
$phpMussel['lang']['siginfo_sub_Targets'] = 'Подсчет по целевым вектором';
$phpMussel['lang']['siginfo_sub_Vendors'] = 'Подсчет по продавцом или источником сигнатуры';
$phpMussel['lang']['siginfo_xkey'] = 'Идентифицированный как «%s».';
...
$phpMussel['lang']['tip_siginfo'] = 'Привет, {username}.<br />На странице информация о сигнатур содержится основная информация об источниках и типах активных сигнатур.';
...
$phpMussel['lang']['info_some_useful_links'] = 'Некоторые полезные ссылки:<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – Фишинг базе данных, используется в сканером URL для phpMussel.</li>
      ...
      <li><a href="https://www.hybrid-analysis.com/">Hybrid Analysis</a> – Hybrid Analysis представляет бесплатный сервис для анализа вредоносного программного, предоставленной <a href="https://www.payload-security.com/">Payload Security</a>.</li>
...
<br />
Ваш код 2FA для входа в интерфейс phpMussel:</p>
<h1>%2$s</h1>
<p>Этот код истекает через 10 минут.</p></center>';
$phpMussel['lang']['msg_subject_2fa'] = 'Двухфакторная аутентификация';
