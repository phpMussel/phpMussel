 ...
 * @see LICENSE.txt
 *
 * This file: Russian language data for the front-end (last modified: 2018.06.17).
 */
...
$phpMussel['lang']['config_signatures_fail_silently'] = 'Реакция phpMussel на отсутсвие подписей или дефект в них. Когда <code>fail_silently</code> деактивирована, то в течение сканирования будет сообщаться об отсутствии Сигнатуры или изъянах в ней. В случае если <code>fail_silently</code> активирована, то отсутствующие или дефектные Сигнатуры будут игнорироваться, не сообщая о проблемах. Эта опция должна оставаться такой, если только Вы не ожидаете отказа системы или чего-то подобного. False = Деактивировано; True = Активировано [Стандарт].';
...
$phpMussel['lang']['link_siginfo'] = 'Информация о Сигнатурке';
...
$phpMussel['lang']['tip_siginfo'] = 'Привет, {username}.<br />На странице информация о сигнатурке содержится основная информация об источниках и типах активных сигнатур.';
...
$phpMussel['lang']['title_siginfo'] = 'phpMussel – Информация о Сигнатурке';
