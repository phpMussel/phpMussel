...
$phpMussel['lang']['Extended Description: Chart.js'] = '使前端能夠生成餅圖。<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a>可通過<a href="https://opensource.org/licenses/MIT">MIT license</a>獲得。';
$phpMussel['lang']['Extended Description: PHPMailer'] = '使用涉及發送電子郵件的任何功能時需要。<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a>可通過<a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>許可證獲得。';
...
$phpMussel['lang']['config_general_disable_webfonts'] = '關閉網絡字體嗎？​True（真）=關閉【標準】；False（假）=不關閉。';
...
$phpMussel['lang']['config_legal_privacy_policy'] = '要顯示在任何生成的頁面的頁腳中的相關隱私政策的地址。​指定一個URL，或留空以禁用。';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = '編寫日誌文件時使用假名的IP地址嗎？​True（真）=使用假名【標準】；False（假）=不使用假名。';
...
$phpMussel['lang']['field_create_new_account'] = '創建新帳戶';
$phpMussel['lang']['field_deactivate'] = '停用';
$phpMussel['lang']['field_delete_account'] = '刪除帳戶';
...
$phpMussel['lang']['field_verify'] = '驗證';
$phpMussel['lang']['field_verify_all'] = '驗證全部';
...
$phpMussel['lang']['label_fmgr_other_sig'] = '其他規則，簽名文件，等等';
$phpMussel['lang']['label_fmgr_safety'] = '安全機制';
...
$phpMussel['lang']['link_accounts'] = '帳戶';
...
$phpMussel['lang']['response_2fa_invalid'] = '輸入了錯誤的2FA代碼。驗證失敗。';
$phpMussel['lang']['response_2fa_valid'] = '驗證成功。';
$phpMussel['lang']['response_accounts_already_exists'] = '一個帳戶與那個用戶名已經存在！';
...
$phpMussel['lang']['response_login_wrong_endpoint'] = '錯誤的端點！';
$phpMussel['lang']['response_possible_problem_found'] = '可能的問題發現。';
...
$phpMussel['lang']['response_sanity_1'] = '文件包含意外的內容！​文件拒絕！';
...
$phpMussel['lang']['security_warning'] = '處理您的請求時出現意外問題。請再試一次。如果問題仍然存在，請聯繫技術支持。';
...
$phpMussel['lang']['tip_2fa_sent'] = '包含2FA代碼的電子郵件已發送到您的電子郵件地址。​請確認以下代碼以獲取對前端的訪問權限。​如果您沒有收到此電子郵件，嘗試登出，等待10分鐘，然後再次登錄以接收包含新代碼的新電子郵件。';
$phpMussel['lang']['tip_accounts'] = '你好，​{username}。​<br />帳戶頁面允許您控制誰可以訪問phpMussel前端。';
...
$phpMussel['lang']['tip_pie_html'] = '單擊組件名稱以獲取更多詳細信息。';
...
$phpMussel['lang']['info_some_useful_links'] = '一些有用的链接：<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – 網絡釣魚數據庫；由phpMussel URL掃描器使用。</li>
      ...
      <li><a href="https://www.hybrid-analysis.com/">Hybrid Analysis</a> – Hybrid Analysis是由<a href="https://www.payload-security.com/">Payload Security</a>提供的免費惡意軟件分析服務。</li>
...
<br />
用於登錄phpMussel前端的2FA代碼：</p>
<h1>%2$s</h1>
<p>此代碼將在10分鐘後到期。</p></center>';
$phpMussel['lang']['msg_subject_2fa'] = '2FA（雙因素身份驗證）';
