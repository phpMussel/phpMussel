 ...
 * @see LICENSE.txt
 *
 * This file: Hindi language data (last modified: 2017.05.29).
 */
...
$phpMussel['lang']['cli_commands'] = " q
 ...
 md5
 - स्ट्रिंग से MD5 हस्ताक्षर उत्पन्न करें [सिंटेक्स: md5 string]।
 sha1
 - स्ट्रिंग से SHA1 हस्ताक्षर उत्पन्न करें [सिंटेक्स: sha1 string]।
 hex_encode
 - बाइनरी स्ट्रिंग को हेक्साडेसिमल में कनवर्ट करें [सिंटेक्स: hex_encode string]।
 - उपनाम: x।
 hex_decode
 - हेक्साडेसिमल को द्विआधारी स्ट्रिंग में कनवर्ट करें [सिंटेक्स: hex_decode string]।
 base64_encode
 - बाइनरी स्ट्रिंग को बेस 64 स्ट्रिंग में कनवर्ट करें [सिंटेक्स: base64_encode string]।
 - उपनाम: b।
 base64_decode
 - बेस 64 स्ट्रिंग को द्विआधारी स्ट्रिंग में कनवर्ट करें [सिंटेक्स: base64_decode string]।
 scan
