...
$phpMussel['lang']['config_attack_specific_decode_threshold'] = 'Limitation facultatif ou seuil à la longueur de brutes données dans laquelle commandes des décodages doivent être détectés (dans le cas où il ya remarquable performance problèmes au cours de l\'analyse). La valeur est un entier représentant la tailles des fichiers en Ko. Défaut = 512 (512Ko). Zéro ou nulle valeur désactive le seuil (supprimant toute restriction basé sur la taille du fichier).';
$phpMussel['lang']['config_attack_specific_general_commands'] = 'Vérifier les fichiers pour les déclarations et commandes générales comme <code>eval()</code> et <code>exec()</code>? False = Non (pas vérifier) [Défaut]; True = Oui (vérifier). Définir à <code>false</code> si vous avez l\'intention à téléchargez de la suivant à votre système ou CMS via votre navigateur: PHP, JavaScript, HTML, python, perl fichiers, etc. Définir à <code>true</code> si vous n\'avez pas supplémentaire protections pour votre système et n\'ont pas l\'intention de téléchargement de ces fichiers. Si vous utilisez supplémentaire sécurité en conjonction avec phpMussel (comme ZB Block), il n\'est pas nécessaire d\'activer cette directive, parce la plupart de que phpMussel va chercher pour (dans le contexte de cette directive) sont duplications de protections qui sont déjà fournis.';
$phpMussel['lang']['config_attack_specific_scannable_threshold'] = 'Limitation facultatif ou seuil à la longueur de brutes données dans laquelle phpMussel est autorisé à lire et à analyser (dans le cas où il ya remarquable performance problèmes au cours de l\'analyse). La valeur est un entier représentant la tailles des fichiers en Ko. Défaut = 32768 (32Mo). Zéro ou nulle valeur désactive le seuil. En général, cette valeur ne doit pas être moins que la moyenne tailles des fichiers des téléchargements que vous voulez et s\'attendent à recevoir de votre serveur ou website, ne devrait pas être plus que la filesize_limit directive, et ne devrait pas être plus que d\'un cinquième de l\'allocation de totale mémoire autorisée à PHP via le <code>php.ini</code> fichier de configuration. Cette directive existe pour tenter d\'empêcher phpMussel d\'utiliser trop de mémoire (ce qui l\'empêcherait d\'être capable d\'analyse fichiers dessus d\'une certaine taille avec succès).';
...
$phpMussel['lang']['config_signatures_detect_shell'] = 'Devrait phpMussel utiliser signatures pour détecter les shell scripts? False = Non; True = Oui [Défaut].';
...
$phpMussel['lang']['response_component_update_error'] = 'Une erreur est survenue lors de la mise à jour du composant.';
...
$phpMussel['lang']['info_some_useful_links'] = 'Quelques liens utiles:<ul>
            <li><a href="https://github.com/Maikuolan/phpMussel/issues">phpMussel Issues @ GitHub</a> – Page de problèmes pour phpMussel (soutien, assistance, etc).</li>
