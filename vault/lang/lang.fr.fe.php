 ...
 * @see LICENSE.txt
 *
 * This file: French language data for the front-end (last modified: 2018.10.16).
 */
...
$phpMussel['lang']['config_attack_specific_chameleon_from_exe'] = 'Vérifier pour les en-têtes d\'exécutables dans les fichiers qui ne sont pas fichiers exécutable ni reconnue comme archives et pour exécutables dont les en-têtes sont incorrects. False = Désactivé ; True = Activé.';
$phpMussel['lang']['config_attack_specific_chameleon_from_php'] = 'Vérifier pour les en-têtes PHP dans les fichiers qui ne sont pas de PHP ni reconnue comme archives. False = Désactivé ; True = Activé.';
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'Détecter les en-têtes incorrects dans les archives et les fichiers compressés. Supporté : BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP. False = Désactivé ; True = Activé.';
$phpMussel['lang']['config_attack_specific_chameleon_to_doc'] = 'Vérifier pour les documents office dont les en-têtes sont incorrects (Supporté : DOC, DOT, PPS, PPT, XLA, XLS, WIZ). False = Désactivé ; True = Activé.';
$phpMussel['lang']['config_attack_specific_chameleon_to_img'] = 'Vérifier pour les images dont les en-têtes sont incorrects (Supporté : BMP, DIB, PNG, GIF, JPEG, JPG, XCF, PSD, PDD, WEBP). False = Désactivé ; True = Activé.';
$phpMussel['lang']['config_attack_specific_chameleon_to_pdf'] = 'Vérifier pour les fichiers PDF dont les en-têtes sont incorrects. False = Désactivé ; True = Activé.';
...
$phpMussel['lang']['config_experimental'] = 'Instable/Expérimental !';
...
$phpMussel['lang']['config_files_check_archives'] = 'Essayer vérifier les contenus des archives ? False = Non (ne pas vérifier) ; True = Oui (vérifier) [Défaut].';
...
$phpMussel['lang']['config_files_max_recursion'] = 'Maximum récursivité profondeur limite pour archives. Défaut = 3.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Désactiver les webfonts ? True = Oui [Défaut] ; False = Non.';
...
$phpMussel['lang']['config_general_forbid_on_block'] = 'Devrait phpMussel envoyer les en-têtes 403 avec le fichier téléchargement bloqué message, ou rester avec l\'habitude 200 bien (200 OK) ? False = Non (200) ; True = Oui (403) [Défaut].';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Le nombre maximal de fichiers pouvant exister dans la quarantaine. Lorsque de nouveaux fichiers sont ajoutés à la quarantaine, si ce nombre est dépassé, les anciens fichiers seront supprimés jusqu\'à ce que le reste ne dépasse plus ce nombre. Défaut = 100.';
...
$phpMussel['lang']['config_general_timeFormat'] = 'Le format de notation de la date/heure utilisé par phpMussel. Des options supplémentaires peuvent être ajoutées sur requête.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'L\'adresse d\'une politique de confidentialité pertinente à afficher dans le pied de page des pages générées. Spécifier une URL, ou laisser vide à désactiver.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymiser les adresses IP lors de la journalisation ? True = Oui ; False = Non [Défaut].';
...
$phpMussel['lang']['label_actual'] = 'Actuel';
$phpMussel['lang']['label_backup_location'] = 'Emplacements de sauvegarde du référentiel (en cas d\'urgence, ou si tout le reste échoue) :';
$phpMussel['lang']['label_blocked'] = 'Téléchargements bloqués';
$phpMussel['lang']['label_branch'] = 'Dernier stable de branche :';
$phpMussel['lang']['label_clientinfo'] = 'Informations sur le client :';
$phpMussel['lang']['label_events'] = 'événements d\'analyse';
$phpMussel['lang']['label_expected'] = 'Attendu';
...
$phpMussel['lang']['label_hide_hash_table'] = 'Masquer la table de hachage';
...
$phpMussel['lang']['label_show_hash_table'] = 'Afficher la table de hachage';
...
$phpMussel['lang']['label_your_ip'] = 'Votre adresse IP :';
$phpMussel['lang']['label_your_ua'] = 'Votre UA :';
...
$phpMussel['lang']['link_siginfo'] = 'Informations sur les Signatures';
...
$phpMussel['lang']['response_sanity_1'] = 'Le fichier contient des contenus inattendus ! Fichier rejeté !';
...
$phpMussel['lang']['siginfo_key_Fake'] = 'Les détections sont de variantes malveillantes et contrefaites d\'entités par ailleurs bénignes (logiciels, scripts, etc).';
$phpMussel['lang']['siginfo_key_HEUR'] = 'Les signatures dérivées de données heuristiques.';
$phpMussel['lang']['siginfo_key_META'] = 'Les signatures fonctionnant avec des métadonnées de fichier (par opposition aux données de fichier).';
$phpMussel['lang']['siginfo_key_Other'] = 'Non identifié ou autre.';
$phpMussel['lang']['siginfo_key_Other_Metadata'] = 'Aucune métadonnée disponible.';
$phpMussel['lang']['siginfo_key_Suspect'] = 'Les détections sont suspectées, mais pas confirmées (peuvent impliquer des combinaisons de plusieurs identifiants).';
$phpMussel['lang']['siginfo_key_Testfile'] = 'Les signatures pour les fichiers de test (les détections ne sont pas malveillantes).';
$phpMussel['lang']['siginfo_key_Total'] = 'Total des signatures actives.';
$phpMussel['lang']['siginfo_key_VT'] = 'Les signatures incluant ou basées sur des données de Virus Total.';
$phpMussel['lang']['siginfo_key_Werewolf'] = 'Des signatures qui traitent des « attaques de werewolf ».';
$phpMussel['lang']['siginfo_sub_Classes'] = 'Compter par classe de fichier de signature';
$phpMussel['lang']['siginfo_sub_Files'] = 'Compter par fichier de signature';
$phpMussel['lang']['siginfo_sub_MalwareTypes'] = 'Compter par type d\'infection ou de programme malveillant';
$phpMussel['lang']['siginfo_sub_SigTypes'] = 'Compter par métadonnées de signature';
$phpMussel['lang']['siginfo_sub_Targets'] = 'Compter par vecteur ciblé';
$phpMussel['lang']['siginfo_sub_Vendors'] = 'Compter par fournisseur ou source de signature';
$phpMussel['lang']['siginfo_xkey'] = 'Identifié comme « %s ».';
...
$phpMussel['lang']['state_email_sent'] = 'E-mail envoyé avec succès à « %s ».';
...
$phpMussel['lang']['tip_siginfo'] = 'Bonjour, {username}.<br />La page d\'informations sur les signatures fournit des informations de base sur les sources et les types des signatures actuellement actives.';
...
$phpMussel['lang']['title_login'] = 'Connexion';
