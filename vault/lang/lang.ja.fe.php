 ...
 * @see LICENSE.txt
 *
 * This file: Japanese language data for the front-end (last modified: 2018.10.15).
 */
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'マクロを含むファイルをブロックしようとしていますか？​ドキュメントやスプレッドシートには実行可能なマクロが含まれている可能性があります。​<code>false</code>（偽） = ブロックしない（Default/デフォルト）；​<code>true</code>（真） = ブロックする。';
...
$phpMussel['lang']['info_some_useful_links'] = '役に立つリンク：<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – phpMussel URLスキャナーで利用される、​フィッシング詐欺データベース。</li>
