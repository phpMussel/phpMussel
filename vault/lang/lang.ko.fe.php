...
$phpMussel['lang']['config_files_max_recursion'] = '아카이브에 대한 최대 재귀 깊이입니다. 기본 설정 = 3.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = '격리에 존재할 수있는 최대 파일 수입니다. 격리 저장소에 새 파일이 추가되면이 수가 초과되면 나머지 파일이 더 이상이 수를 초과하지 않을 때까지 오래된 파일이 삭제됩니다. 기본 설정은 100입니다.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = '생성 된 페이지의 꼬리말에 표시 할 관련 개인 정보 정책 방침의 주소입니다. URL 지정, 또는 사용하지 않으려면 비워 두십시오.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = '로그 파일을 쓸 때 가명으로 하다 IP 주소? True = 예 (Default / 기본 설정); False = 아니오.';
...
$phpMussel['lang']['field_confirm'] = '확인';
...
$phpMussel['lang']['response_2fa_invalid'] = '2FA 코드가 잘못 입력되었습니다. 인증 실패.';
$phpMussel['lang']['response_2fa_valid'] = '성공적으로 인증되었습니다.';
...
$phpMussel['lang']['tip_2fa_sent'] = '2FA 코드가 포함 된 이메일이 귀하의 이메일 주소로 발송되었습니다. 프런트 엔드에 액세스하려면 아래 코드를 확인하십시오. 이 이메일을받지 못한 경우 로그 아웃을 시도하고 10 분을 기다린 후 다시 로그인하여 새 코드가 포함 된 새 이메일을 수신 할 수 있습니다.';
...
$phpMussel['lang']['msg_subject_2fa'] = '2FA (이중 인증)';
