...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'Makro içeren dosyaları engellemeye çalışın mı? Bazı belge türleri ve elektronik tablolar yürütülebilir makrolar içerebilir, böylece tehlikeli bir potansiyel zararlı yazılım vektörü sağlayabilir. Yanlış/False = Engelleme [Varsayılan]; Doğru/True = Engelle.';
...
$phpMussel['lang']['config_general_allow_symlinks'] = 'Bazen phpMussel, bir dosyaya belirli bir şekilde adlandırıldığında doğrudan erişemez. Dosyanın, dolaylı olarak symlink\'ler erişilmesi bazen bu sorunu çözebilir. Ancak, bu her zaman geçerli bir çözüm değildir, çünkü bazı sistemlerde, symlink\'leri kullanmak yasak olabilir veya yönetici ayrıcalıkları gerektirebilir. Bu yönerge phpMussel\'in dosyalara dolaylı olarak erişmek için symlink\'leri kullanıp kullanmayacağını belirlemede kullanılır, doğrudan erişim mümkün değilse. True = Symlink\'leri kullanımını etkinleştir; False = Symlink\'leri kullanımını devre dışı bırak [Varsayılan].';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Webfontlarını devre dışı bırak? Doğru/True = Evet [Varsayılan]; Yanlış/False = Hayır.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Karantinada bulunabilecek maksimum dosya sayısı. Karantinaya yeni dosyalar eklendiğinde, bu sayı aşılırsa, kalan dosyalar bu sayıyı geçmediği sürece eski dosyalar silinir. Varsayılan = 100.';
...
$phpMussel['lang']['info_some_useful_links'] = 'Bazı kullanışlı bağlantılar:<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – Kimlik avı veritabanı (URL tarayıcısı tarafından kullanılır).</li>
