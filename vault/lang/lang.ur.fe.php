 ...
 * @see LICENSE.txt
 *
 * This file: Urdu language data for the front-end (last modified: 2018.06.26).
 */
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Webfonts کے غیر فعال کریں؟ True (سچے) = جی ہاں [پہلے سے طے شدہ]؛ False (جھوٹی) = کوئی.';
