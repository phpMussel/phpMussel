...
$phpMussel['lang']['config_attack_specific_decode_threshold'] = 'اختیاری حد یا خام ڈیٹا جس کے اندر ڈیکوڈ کمانڈز کے پتہ جانی چاہئے کی لمبائی کے حد سے (کے معاملے میں کسی بھی نمایاں کارکردگی کے مسائل جبکہ سکیننگ سے ہیں). ویلیو میں KB فائل کی نمائندگی ایک عدد صحیح ہے. پہلے سے طے شدہ = 512 (512KB). زیرو یا شہوت انگیز null قیمت (فائل کی بنیاد پر اس طرح کے کسی بھی حد کو ہٹانے کے) حد سے نااہل کیا.';
$phpMussel['lang']['config_attack_specific_scannable_threshold'] = 'کہ phpMussel پڑھیں اور سکین کرنے کی اجازت ہے خام ڈیٹا کی لمبائی کے اختیاری کسی حد یا حد سے (کے معاملے میں کسی بھی نمایاں کارکردگی کے مسائل جبکہ سکیننگ سے ہیں). ویلیو میں KB فائل کی نمائندگی ایک عدد صحیح ہے. پہلے سے طے شدہ = 32768 (32MB). زیرو یا خالی قدر حد سے غیر فعال. عام طور پر، اس کی قیمت آپ چاہتے ہیں اور آپ کے سرور یا ویب سائٹ کو حاصل کرنے کی توقع ہے کہ فائل اپ لوڈ کی اوسط فائل سے کم نہیں ہونا چاہئے، ٹی filesize_limit ہدایت کے مقابلے میں زیادہ ہو جائے\چاہیے، اور تقریبا ایک سے زیادہ پانچویں نہیں ہونا چاہئے کل قابل اجازت میموری مختص ذریعے PHP کو عطا کی<code>php.ini</code> کنفیگریشن فائل. یہ ہدایت بہت زیادہ میموری کا استعمال کرتے ہوئے کی طرف سے phpMussel کو روکنے کے لئے کوشش کرنے کے لئے موجود ہے (کہ کامیابی کی ایک مخصوص فائل کے اوپر فائلوں کو اسکین کرنے کے قابل ہونے کی وجہ سے اس کی روک تھام کرے گا).';
...
$phpMussel['lang']['config_general_timeFormat'] = 'phpMussel کی طرف سے استعمال کی تاریخوں کا فارم. ذیل کی فہرست سے ایک اختیار کو منتخب کریں. اضافی اختیارات درخواست پر شامل کیا جا سکتا ہے.';
$phpMussel['lang']['config_general_timeOffset'] = 'آپ کے سرور کے وقت آپ کے مقامی وقت کے مماثل نہیں ہے تو، آپ کو آپ کی ضروریات کے مطابق phpMussel طرف سے پیدا تاریخ / وقت کی معلومات کو ایڈجسٹ کرنے کے لئے یہاں آفسیٹ ایک وضاحت کر سکتے ہیں. یہ عام طور پر کی php.ini </code> کے فائل، لیکن کبھی کبھی ایسا کرنا ہمیشہ ممکن نہیں ہے، اور اسی طرح (اس طرح محدود مشترکہ ہوسٹنگ فراہم کرنے والے کے ساتھ کام کرتے وقت کے طور پر)، اس اختیار کو آپ کی <code> میں ٹائم زون ہدایت کو ایڈجسٹ کرنے کی بجائے سفارش کی جاتی ہے یہاں فراہم کی جاتی ہے. آف سیٹ منٹ میں ہے. مثال (ایک گھنٹے کا اضافہ کرنے کے لئے): <code>timeOffset=60</code>';
$phpMussel['lang']['config_general_truncate'] = 'وہ ایک خاص سائز تک پہنچنے میں جب صاف لاگ مسلیں؟ ویلیو میں KB زیادہ سے زیادہ سائز ہے. جب 0، وہ غیر معینہ مدت تک ترقی کر سکتا ہے (پہلے سے طے). نوٹ: واحد فائلوں پر لاگو ہوتا ہے! فائلیں اجتماعی غور نہیں کر رہے ہیں.';
