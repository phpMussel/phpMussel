...
$phpMussel['lang']['cli_ln2'] = " Спасибо за использование phpMussel, PHP сценария предназначенного для обнаружения троянов, вирусов, вредоносных программ и других угроз для файлов загруженных в вашу систему, на основе подписей ClamAV и\n других.\n\n PHPMUSSEL АВТОРСКИЕ ПРАВА 2013 и позже GNU/GPLv2 от Caleb M (Maikuolan).\n\n                                     ~ ~ ~\n\n";
...
$phpMussel['lang']['denied_reason'] = 'Ваша загрузка была заблокирована по причинам перечисленным ниже / Your upload was blocked for the reasons listed below:';
...
$phpMussel['lang']['phpmussel_disabled'] = 'phpMussel неактивен.';
$phpMussel['lang']['phpmussel_disabled_already'] = 'phpMussel уже неактивен.';
$phpMussel['lang']['phpmussel_enabled'] = 'phpMussel активен.';
$phpMussel['lang']['phpmussel_enabled_already'] = 'phpMussel уже активен.';
...
$phpMussel['lang']['scan_map_corrupted'] = 'Повреждена подпись карты';
$phpMussel['lang']['scan_map_missing'] = 'Отсутствует подпись карты';
