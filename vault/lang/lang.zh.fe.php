 ...
 * @see LICENSE.txt
 *
 * This file: Chinese (simplified) language data for the front-end (last modified: 2017.03.04).
 */
...
$phpMussel['lang']['config_attack_specific_block_control_characters'] = '受阻任何文件包含任何控制字符吗（以外换行符）？ (<code>[\x00-\x08\x0b\x0c\x0e\x1f\x7f]</code>) 如果您只上传纯文本，您可以激活这个指令以提供某些另外保护在您的系统。然而，如果您上传任何事以外纯文本，激活这个可能结果在假阳性。 False = 不受阻【默认】； True = 受阻。';
