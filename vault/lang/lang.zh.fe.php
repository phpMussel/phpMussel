...
$phpMussel['lang']['config_PHPMailer_Enable2FA'] = '该指令确定是否将2FA用于前端帐户。';
$phpMussel['lang']['config_PHPMailer_EventLog'] = '用于记录与PHPMailer相关的所有事件的文件。​指定一个文件名，​或留空以禁用。';
$phpMussel['lang']['config_PHPMailer_Host'] = '用于出站电子邮件的SMTP主机。';
$phpMussel['lang']['config_PHPMailer_Password'] = '通过SMTP发送电子邮件时使用的密码。';
$phpMussel['lang']['config_PHPMailer_Port'] = '用于出站电子邮件的端口号。​标准=587。';
$phpMussel['lang']['config_PHPMailer_SMTPAuth'] = '此指令确定是否对SMTP会话进行身份验证（通常应该保持不变）。';
$phpMussel['lang']['config_PHPMailer_SMTPSecure'] = '通过SMTP发送电子邮件时使用的协议（TLS或SSL）。';
$phpMussel['lang']['config_PHPMailer_SkipAuthProcess'] = '将此指令设置为<code>true</code>会指示PHPMailer跳过通过SMTP发送电子邮件时通常会发生的正常身份验证过程。​应该避免这种情况，因为跳过此过程可能会将出站电子邮件暴露给MITM攻击，但在此过程阻止PHPMailer连接到SMTP服务器的情况下可能是必要的。';
$phpMussel['lang']['config_PHPMailer_Username'] = '通过SMTP发送电子邮件时使用的用户名。';
$phpMussel['lang']['config_PHPMailer_addReplyToAddress'] = '通过SMTP发送电子邮件时引用的回复地址。';
$phpMussel['lang']['config_PHPMailer_addReplyToName'] = '通过SMTP发送电子邮件时引用的回复姓名。';
$phpMussel['lang']['config_PHPMailer_setFromAddress'] = '通过SMTP发送电子邮件时引用的发件人地址。';
$phpMussel['lang']['config_PHPMailer_setFromName'] = '通过SMTP发送电子邮件时引用的发件人姓名。';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = '尝试阻止任何包含宏的文件吗？​某些文档和电子表格类型可能包含可执行的宏，因此提供了危险的潜在恶意软件向量。​False（假）=不阻止【默认】；​True（真）=阻止。';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = '检测在存档和压缩文件中的错误标头。已支持：BZ/BZIP2，GZ/GZIP，LZF，RAR，ZIP。​False（假）=是关闭；True（真）=是激活。';
...
$phpMussel['lang']['config_experimental'] = '不稳定/实验！';
...
$phpMussel['lang']['config_files_check_archives'] = '尝试匹配存档内容吗？​False（假）=不匹配；True（真）=匹配【默认】。';
...
$phpMussel['lang']['config_files_max_recursion'] = '最大存档递归深度限。​默认=3。';
...
$phpMussel['lang']['config_general_disable_webfonts'] = '关闭网络字体吗？​True（真）=关闭【标准】；False（假）=不关闭。';
...
$phpMussel['lang']['config_general_log_rotation_action'] = '日志轮转限制了任何时候应该存在的日志文件的数量。​当新的日志文件被创建时，如果日志文件的指定的最大数量已经超过，将执行指定的操作。​您可以在此处指定所需的操作。​“Delete”=删除最旧的日志文件，直到不再超出限制。​“Archive”=首先归档，然后删除最旧的日志文件，直到不再超出限制。';
$phpMussel['lang']['config_general_log_rotation_limit'] = '日志轮转限制了任何时候应该存在的日志文件的数量。​当新的日志文件被创建时，如果日志文件的指定的最大数量已经超过，将执行指定的操作。​您可以在此指定所需的限制。​值为“0”将禁用日志轮转。';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = '隔离中可以存在的最大文件数量。​新文件添加到隔离时，如果超过此数量，则旧文件将被删除，直到剩余的文件不再超过此数量。​标准=100。';
...
$phpMussel['lang']['confirm_action'] = '你确定要“%s”吗？';
$phpMussel['lang']['field_2fa'] = '2FA代码';
...
$phpMussel['lang']['field_create_new_account'] = '创建新帐户';
$phpMussel['lang']['field_deactivate'] = '停用';
$phpMussel['lang']['field_delete_account'] = '删除帐户';
...
$phpMussel['lang']['label_backup_location'] = '存储库备份位置（在紧急情况下，或如果一切都失败了）：';
...
$phpMussel['lang']['label_expected'] = '预期';
...
$phpMussel['lang']['label_hide_hash_table'] = '隐藏哈希表';
$phpMussel['lang']['label_never'] = '决不';
...
$phpMussel['lang']['label_show_hash_table'] = '显示哈希表';
...
$phpMussel['lang']['link_accounts'] = '帐户';
...
$phpMussel['lang']['link_siginfo'] = '签名信息';
...
$phpMussel['lang']['response_accounts_already_exists'] = '一个帐户与那个用户名已经存在！';
$phpMussel['lang']['response_accounts_created'] = '帐户成功创建！';
$phpMussel['lang']['response_accounts_deleted'] = '帐户成功删除！';
$phpMussel['lang']['response_accounts_doesnt_exist'] = '那个帐户不存在。';
...
$phpMussel['lang']['siginfo_key_Fake'] = '检测是否则良性实体（软件，脚本，等）的恶意伪造变体。';
$phpMussel['lang']['siginfo_key_HEUR'] = '从启发式数据派生的签名。';
$phpMussel['lang']['siginfo_key_META'] = '处理文件元数据的签名（与文件数据相反）。';
$phpMussel['lang']['siginfo_key_Other'] = '不明或其他。';
$phpMussel['lang']['siginfo_key_Other_Metadata'] = '无可用的元数据。';
$phpMussel['lang']['siginfo_key_Suspect'] = '检测是可疑的，但未得到证实（可能涉及各种标识符的组合）。';
$phpMussel['lang']['siginfo_key_Testfile'] = '测试文件的签名（即，不是恶意的检测）。';
$phpMussel['lang']['siginfo_key_Total'] = '总活动签名。';
$phpMussel['lang']['siginfo_key_VT'] = '签名包括或基于Virus Total的数据。';
$phpMussel['lang']['siginfo_key_Werewolf'] = '处理“狼人攻击”的签名。';
$phpMussel['lang']['siginfo_sub_Classes'] = '签名文件类的数量';
$phpMussel['lang']['siginfo_sub_Files'] = '签名文件的数量';
$phpMussel['lang']['siginfo_sub_MalwareTypes'] = '感染或恶意软件类型的数量';
$phpMussel['lang']['siginfo_sub_SigTypes'] = '签名元数据的数量';
$phpMussel['lang']['siginfo_sub_Targets'] = '向量目标的数量';
$phpMussel['lang']['siginfo_sub_Vendors'] = '签名供应商或来源的数量';
$phpMussel['lang']['siginfo_xkey'] = '标识符是“%s”。';
$phpMussel['lang']['state_async_deny'] = '权限不足以执行异步请求。尝试再次登录。';
$phpMussel['lang']['state_cache_is_empty'] = '缓存是空的。';
...
$phpMussel['lang']['state_email_sent'] = '电子邮件已成功发送至“%s”。';
$phpMussel['lang']['state_failed_missing'] = '任务失败，因为必要的组件不可用。';
$phpMussel['lang']['state_loading'] = '载入中...';
$phpMussel['lang']['state_loadtime'] = '页面请求在<span class="txtRd">%s</span>秒内完成。';
$phpMussel['lang']['state_logged_in'] = '已登录。';
$phpMussel['lang']['state_logged_in_2fa_pending'] = '已登录，2FA待定。';
...
$phpMussel['lang']['state_password_not_valid'] = '警告：此帐户不​使用有效的密码！';
...
$phpMussel['lang']['tip_accounts'] = '你好，​{username}。​<br />帐户页面允许您控制谁可以访问phpMussel前端。';
...
$phpMussel['lang']['tip_siginfo'] = '你好，​{username}。<br />签名信息页面提供了有关当前活动签名的来源和类型的一些基本信息。';
...
$phpMussel['lang']['info_some_useful_links'] = '一些有用的链接：<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – 网络钓鱼数据库；由phpMussel URL扫描器使用。</li>
