 ...
 * @see LICENSE.txt
 *
 * This file: Bangla language data for the front-end (last modified: 2018.02.28).
 */
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'ওয়েবফটগুলি অক্ষম করবেন? True = হাঁ; False = না [ডিফল্ট]।';
