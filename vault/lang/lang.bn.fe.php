 ...
 * @see LICENSE.txt
 *
 * This file: Bangla language data for the front-end (last modified: 2018.06.26).
 */
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'সংগ্রাহক মধ্যে উপস্থিত হতে পারে ফাইলের সর্বাধিক সংখ্যা। যখন নতুন ফাইল সংযোজনে যোগ করা হয়, যদি এই নম্বরটি অতিক্রম করা হয়, তাহলে পুরানো ফাইল মুছে ফেলা হবে না যতক্ষন বাকি অবশিষ্ট এই সংখ্যাটি অতিক্রম করে না। ডিফল্ট = 100।';w
