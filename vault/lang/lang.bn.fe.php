...
$phpMussel['lang']['config_PHPMailer_Enable2FA'] = 'এই নির্দেশটি ফ্রন্ট-এন্ড অ্যাকাউন্টগুলির জন্য 2FA ব্যবহার করে কিনা তা নির্ধারণ করে।';
$phpMussel['lang']['config_PHPMailer_EventLog'] = 'PHPMailer সম্পর্কিত সকল ঘটনা লগইন করার জন্য একটি ফাইল। ফাইলের নাম উল্লেখ করুন, অথবা নিষ্ক্রিয় করতে ফাঁকা রাখুন।';
$phpMussel['lang']['config_PHPMailer_Host'] = 'আউটবাউন্ড ইমেলের জন্য SMTP হোস্ট ব্যবহার করতে হবে।';
$phpMussel['lang']['config_PHPMailer_Password'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য পাসওয়ার্ডটি।';
$phpMussel['lang']['config_PHPMailer_Port'] = 'আউটবাউন্ড ইমেলের জন্য ব্যবহার করার জন্য পোর্ট নাম্বার। ডিফল্ট = "587"।';
$phpMussel['lang']['config_PHPMailer_SMTPAuth'] = 'এই নির্দেশটি SMTP সেশনের প্রমাণীকরণ কিনা তা নির্ধারণ করে (সাধারণত এই একা ছেড়ে দেওয়া উচিত)।';
$phpMussel['lang']['config_PHPMailer_SMTPSecure'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য প্রোটোকল (TLS বা SSL)।';
...
$phpMussel['lang']['config_PHPMailer_Username'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য ব্যবহারকারীর নাম।';
$phpMussel['lang']['config_PHPMailer_addReplyToAddress'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য উত্তর ঠিকানা।';
$phpMussel['lang']['config_PHPMailer_addReplyToName'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য উত্তর নাম।';
$phpMussel['lang']['config_PHPMailer_setFromAddress'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য প্রেরক ঠিকানা।';
$phpMussel['lang']['config_PHPMailer_setFromName'] = 'SMTP এর মাধ্যমে ইমেল পাঠানোর সময় ব্যবহারের জন্য প্রেরক নাম।';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'ম্যাক্রো ধারণকারী কোন ফাইল ব্লক করার চেষ্টা করবেন? কিছু ধরণের দস্তাবেজ এবং স্প্রেডশীটগুলিতে এক্সিকিউটেবল ম্যাক্রো থাকতে পারে, এইভাবে একটি বিপজ্জনক সম্ভাব্য ম্যালওয়্যার ভেক্টর প্রদান করে। False = ব্লক করবেন না [ডিফল্ট]; True = ব্লক করুন।';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'PHP কোড ধারণ করার জন্য ফাইল এক্সটেনশনগুলোর তালিকা, কমা দ্বারা পৃথক করা। যদি PHP chameleon হামলার সনাক্তকরণ সক্রিয় থাকে, PHP কোড ধারণকারী ফাইলগুলি, এই তালিকায় না এমন এক্সটেনশানগুলিকে PHP chameleon আক্রমণ হিসাবে সনাক্ত করা হবে।';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'আর্কাইভ এবং সংকুচিত ফাইল ভুল হেডার সনাক্ত করুন। সমর্থিত: BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP। False = না; True = হাঁ।';
...
$phpMussel['lang']['config_experimental'] = 'অস্থায়ী/পরীক্ষামূলক!';
...
$phpMussel['lang']['config_files_check_archives'] = 'আর্কাইভের বিষয়বস্তু পরীক্ষা করার চেষ্টা? False = চেক করবেন না; True = চেক করুন [ডিফল্ট]।';
...
$phpMussel['lang']['config_files_max_recursion'] = 'আর্কাইভগুলির জন্য সর্বাধিক পুনরাবৃত্তি গভীরতা সীমা। ডিফল্ট = "3"।';
...
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'লগ লেখার সময় IP ঠিকানাগুলি pseudonymize? True = হাঁ [ডিফল্ট]; False = না।';
...
$phpMussel['lang']['field_2fa'] = '2FA কোড';
...
$phpMussel['lang']['field_confirm'] = 'নিশ্চিত করা';
...
$phpMussel['lang']['label_fmgr_free_space'] = 'উপলব্ধ ডিস্ক স্থান: ';
$phpMussel['lang']['label_fmgr_other_sig'] = 'অন্যান্য নিয়ম, স্বাক্ষর ফাইল, ইত্যাদি';
$phpMussel['lang']['label_fmgr_safety'] = 'নিরাপত্তা প্রক্রিয়া';
...
$phpMussel['lang']['response_2fa_invalid'] = 'ভুল 2FA কোড প্রবেশ করানো হয়েছে। প্রমাণীকরণ ব্যর্থ হয়েছে।';
$phpMussel['lang']['response_2fa_valid'] = 'সফলভাবে প্রমাণিত।';
...
$phpMussel['lang']['state_email_sent'] = 'ইমেল সফলভাবে "%s" এ পাঠানো হয়েছে।';
$phpMussel['lang']['state_failed_missing'] = 'কার্য ব্যর্থ হয়েছে কারণ একটি প্রয়োজনীয় উপাদান অনুপলব্ধ।';
...
$phpMussel['lang']['state_logged_in'] = 'লগ ইন হয়।';
$phpMussel['lang']['state_logged_in_2fa_pending'] = 'লগ ইন হয় + 2FA মুলতুবি।';
$phpMussel['lang']['state_logged_out'] = 'লগ আউট হয়।';
...
$phpMussel['lang']['tip_pie_html'] = 'আরো বিস্তারিত জানার জন্য কম্পোনেন্ট নাম ক্লিক করুন।';
...
$phpMussel['lang']['title_login'] = 'লগ ইন';
...
$phpMussel['lang']['msg_subject_2fa'] = 'দুই-ফ্যাক্টর প্রমাণীকরণ';
