 ...
 * @see LICENSE.txt
 *
 * This file: Vietnamese language data (last modified: 2018.07.31).
 */
...
$phpMussel['lang']['PrivacyPolicy'] = 'Chính sách bảo mật';
...
$phpMussel['lang']['macros_not_permitted'] = 'Macro không được phép';
