 ...
 * @see LICENSE.txt
 *
 * This file: Vietnamese language data (last modified: 2016.10.12).
 */
...
$phpMussel['lang']['controls_lockout'] = 'Cho phép các điều khiển khóa máy của phpMussel.';
$phpMussel['lang']['core_scriptfile_missing'] = 'Bản tập tin chính đang thiểu! Xin hảy cài đặt lại phpMussel.';
...
$phpMussel['lang']['phpmussel_disabled'] = 'phpMussel bị vô hiệu.';
$phpMussel['lang']['phpmussel_disabled_already'] = 'phpMussel đã bị tất.';
$phpMussel['lang']['phpmussel_enabled'] = 'phpMussel cho phép.';
$phpMussel['lang']['phpmussel_enabled_already'] = 'phpMussel đã được cho phép.';
