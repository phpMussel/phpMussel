 ...
 * @see LICENSE.txt
 *
 * This file: Vietnamese language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Được xây dựng vào phpMussel là một máy quét URL, khả năng phát hiện các URL độc hại từ bên trong bất kỳ dữ liệu hay tập tin được quét. Để cho phép máy quét URL, chỉ định tên của các tập tin chữ ký để sử dụng, định giới bằng dấu phẩy.';
