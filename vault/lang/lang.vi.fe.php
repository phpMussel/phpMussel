 ...
 * @see LICENSE.txt
 *
 * This file: Vietnamese language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_attack_specific_decode_threshold'] = 'Giới hạn tùy chọn hay ngưỡng cho chiều dài của dữ liệu thô trong đó các lệnh giải mã nên được phát hiện (trong trường hợp có bất kỳ vấn đề hiệu suất đáng chú ý trong khi quét). Giá trị là một số nguyên đại diện cho kích thước tập tin trong KB. Mặc định = 512 (512KB). Số không hay số null vô hiệu hóa các ngưỡng (loại bỏ bất kỳ giới hạn dựa trên kích cỡ tập tin).';
$phpMussel['lang']['config_attack_specific_general_commands'] = 'Tìm kiếm nội dung của tập tin cho statement (báo cáo) và lệnh chung như thế `eval()` và `exec()`? False = Không kiểm tra [Mặc định]; True = Kiểm tra. Vô hiệu hóa tùy chọn này nếu bạn dự định tải lên những việc sau đây để một hệ thống hay CMS của bạn thông qua trình duyệt của bạn: PHP, JavaScript, HTML, python, perl, vân vân. Kích hoạt tùy chọn này nếu bạn không có bất kỳ sự bảo vệ thêm trên hệ thống của bạn và không có ý định để tải lên các tập tin đó. Nếu bạn sử dụng an ninh bổ sung kết hợp với phpMussel (như thế ZB Block), không cần phải kích hoạt tùy chọn này, bởi vì hầu hết những gì phpMussel sẽ tìm (trong bối cảnh các tùy chọn này) là sự trùng lặp của bảo vệ rằng sẽ rất có thể đã được cung cấp.';
$phpMussel['lang']['config_attack_specific_scannable_threshold'] = 'Giới hạn tùy chọn hay ngưỡng cho chiều dài của dữ liệu mà phpMussel được phép đọc và quét (trong trường hợp có bất kỳ vấn đề hiệu suất đáng chú ý trong khi quét). Giá trị là một số nguyên đại diện cho kích thước tập tin trong KB. Mặc định = 32768 (32MB). Số không hay số null vô hiệu hóa các ngưỡng. Nói chung, giá trị này không nên được ít hơn kích thước trung bình của tải lên tập tin bạn muốn và mong đợi để nhận được đến máy chủ hay trang mạng của bạn, không nên được ít hơn tùy chọn filesize_limit, và không nên được ít hơn khoảng một phần năm tổng số cấp phát bộ nhớ cấp cho PHP thông qua tập tin cấu hình `php.ini`. Tùy chọn này tồn tại để cố gắng ngăn chặn phpMussel từ việc sử dụng quá nhiều bộ nhớ (mà sẽ ngăn chặn nó từ việc có thể quét các tập tin thành công trên một kích thước tập tin nhất định).';
...
$phpMussel['lang']['config_signatures_fail_silently'] = 'phpMussel nên báo cáo khi tập tin chữ ký bị mất hay bị hỏng? Nếu `fail_silently` được vô hiệu hóa, tập tin bị mất hay bị hỏng sẽ được báo cáo khi quét, và nếu `fail_silently` được kích hoạt, tập tin bị mất hay bị hỏng sẽ bị bỏ qua, với báo cáo quét cho những tập tin mà không có bất kỳ vấn đề. Điều này thường cần được ở một mình trừ khi bạn gặp sự cố hay vấn đề tương tự. False = Không cho phép; True = Cho phép [Mặc định].';
$phpMussel['lang']['config_signatures_MD5'] = 'Kiểm tra chống lại chữ ký MD5 khi quét? Nếu vậy, chỉ định tên của các tập tin chữ ký để sử dụng, định giới bằng dấu phẩy.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Kiểm tra tập tin PE (portable executable / thực thi di động; EXE, DLL, vv) chống lại chữ ký kéo dài PE khi quét? Nếu vậy, chỉ định tên của các tập tin chữ ký để sử dụng, định giới bằng dấu phẩy.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Kiểm tra tập tin PE (portable executable / thực thi di động; EXE, DLL, vv) chống lại chữ ký phần PE khi quét? Nếu vậy, chỉ định tên của các tập tin chữ ký để sử dụng, định giới bằng dấu phẩy.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Được xây dựng vào phpMussel là một máy quét URL, khả năng phát hiện các URL độc hại từ bên trong bất kỳ dữ liệu hay tập tin được quét. Để cho phép máy quét URL, đặt tùy chọn `urlscanner` để true; Để vô hiệu hóa nó, đặt tùy chọn này để false.';
...
$phpMussel['lang']['tip_file_manager'] = 'Hello, {username}.<br />Quản lý tập tin cho phép bạn xóa bỏ, chỉnh sửa, tải lên, và tải về các tập tin. Sử dụng thận trọng (bạn có thể phá vỡ cài đặt của bạn với điều này).';
