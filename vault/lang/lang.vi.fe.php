...
$phpMussel['lang']['Extended Description: Chart.js'] = 'Cho phép front-end tạo biểu đồ hình tròn.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> có sẵn qua <a href="https://opensource.org/licenses/MIT">MIT license</a>.';
$phpMussel['lang']['Extended Description: PHPMailer'] = 'Cần thiết để sử dụng bất kỳ chức năng nào liên quan đến việc gửi email.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> có sẵn qua giấy phép <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>.';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'Thử chặn bất kỳ tập tin nào chứa macro? Một số loại tài liệu và bảng tính có thể chứa macro thực thi, do đó cung cấp một vectơ phần mềm độc hại tiềm ẩn nguy hiểm. False = Không chặn [Mặc định]; True = Chặn.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Vô hiệu hóa các webfont? True = Vâng [Mặc định]; False = Không.';
...
$phpMussel['lang']['config_general_log_rotation_action'] = 'Xoay vòng nhật ký giới hạn số lượng của tập tin nhật ký có cần tồn tại cùng một lúc. Khi các tập tin nhật ký mới được tạo, nếu tổng số lượng tập tin nhật ký vượt quá giới hạn được chỉ định, hành động được chỉ định sẽ được thực hiện. Bạn có thể chỉ định hành động mong muốn tại đây. Delete = Xóa các tập tin nhật ký cũ nhất, cho đến khi giới hạn không còn vượt quá. Archive = Trước tiên lưu trữ, và sau đó xóa các tập tin nhật ký cũ nhất, cho đến khi giới hạn không còn vượt quá.';
$phpMussel['lang']['config_general_log_rotation_limit'] = 'Xoay vòng nhật ký giới hạn số lượng của tập tin nhật ký có cần tồn tại cùng một lúc. Khi các tập tin nhật ký mới được tạo, nếu tổng số lượng tập tin nhật ký vượt quá giới hạn được chỉ định, hành động được chỉ định sẽ được thực hiện. Bạn có thể chỉ định giới hạn mong muốn tại đây. Giá trị 0 sẽ vô hiệu hóa xoay vòng nhật ký.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Số lượng tập tin tối đa có thể tồn tại trong kiểm dịch. Khi tập tin mới được thêm vào trong kiểm dịch, nếu số này vượt quá, các tập tin cũ sẽ bị xóa cho đến khi phần còn lại không còn vượt quá con số này. Mặc định = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'Địa chỉ của chính sách bảo mật liên quan được hiển thị ở chân trang của bất kỳ trang nào được tạo. Chỉ định URL, hoặc để trống để vô hiệu hóa.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymise địa chỉ IP khi viết các tập tin nhật ký? True = Vâng; False = Không [Mặc định].';
...
$phpMussel['lang']['confirm_action'] = 'Bạn có chắc chắn muốn "%s" không?';
$phpMussel['lang']['field_2fa'] = 'Mã 2FA';
...
$phpMussel['lang']['state_email_sent'] = 'Email được gửi thành công tới "%s".';
$phpMussel['lang']['state_failed_missing'] = 'Tác vụ không thành công vì không có thành phần cần thiết.';
...
$phpMussel['lang']['state_logged_in'] = 'Đã đăng nhập.';
$phpMussel['lang']['state_logged_in_2fa_pending'] = 'Đã đăng nhập + Đang chờ xử lý 2FA.';
$phpMussel['lang']['state_logged_out'] = 'Đã đăng xuất.';
