 ...
 * @see LICENSE.txt
 *
 * This file: Chinese (traditional) language data (last modified: 2016.10.12).
 */
...
$phpMussel['lang']['cli_ln2'] = "謝謝對於使用phpMussel，一個PHP腳本旨在檢測木馬，病毒，惡意軟件，和其他威脅在文件上傳到您的系統隨地這個腳本是叫，根據ClamAV的簽名和其他簽名。\n\n PHPMUSSEL版權2013和此後GNU/GPLv.2通過Caleb M （Maikuolan）。\n\n                                     ~ ~ ~\n\n";
...
$phpMussel['lang']['controls_lockout'] = 'phpMussel控制閉鎖是啟用。';
$phpMussel['lang']['core_scriptfile_missing'] = '核心文件是丟失！請重新安裝phpMussel。';
$phpMussel['lang']['corrupted'] = '檢測損壞PE';
$phpMussel['lang']['denied'] = '上傳是否認！';
$phpMussel['lang']['denied_other'] = 'Upload Denied! Téléchargement Refusé! Subida Denegada! Caricamento Negato! Upload verweigert! Upload Geweigerd! アップロード拒否! 上传是否认! Uppladda Nekas! Загрузка Отказана! Augšupielādēt Liegta! 업로드 거부! Sự tải lên đã bị từ chối!';
$phpMussel['lang']['denied_reason'] = '您的上傳被拒绝由于这些原因 / Your upload was blocked for the reasons listed below:';
...
$phpMussel['lang']['phpmussel_disabled'] = 'phpMussel關閉。';
$phpMussel['lang']['phpmussel_disabled_already'] = 'phpMussel已關閉。';
$phpMussel['lang']['phpmussel_enabled'] = 'phpMussel激活。';
$phpMussel['lang']['phpmussel_enabled_already'] = 'phpMussel已激活。';
...
$phpMussel['lang']['scan_map_corrupted'] = '簽名地圖是損壞';
$phpMussel['lang']['scan_map_missing'] = '簽名地圖是失踪';
