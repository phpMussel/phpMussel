 ...
 * @see LICENSE.txt
 *
 * This file: English language data for the front-end (last modified: 2017.04.17).
 */
...
$phpMussel['lang']['config_general_timeFormat'] = 'The date/time notation format used by phpMussel. Select an option from the list below. Additional options may be added upon request.';
