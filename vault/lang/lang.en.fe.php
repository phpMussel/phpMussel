 ...
 * @see LICENSE.txt
 *
 * This file: English language data for the front-end (last modified: 2017.03.04).
 */
...
$phpMussel['lang']['config_general_timeOffset'] = 'If your server time doesn\'t match your local time, you can specify an offset here to adjust the date/time information generated by phpMussel according to your needs. It\'s generally recommended instead to adjust the timezone directive in your <code>php.ini</code> file, but sometimes (such as when working with limited shared hosting providers) this isn\'t always possible to do, and so, this option is provided here. Offset is in minutes. Example (to add one hour): <code>timeOffset=60</code>';
