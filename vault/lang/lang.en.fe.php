 ...
 * @see LICENSE.txt
 *
 * This file: English language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Built into phpMussel is a URL scanner, capable of detecting malicious URLs from within any data or files scanned. To enable the URL scanner, specify the names of the signature files to use, delimited by commas.';
