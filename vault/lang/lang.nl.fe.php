 ...
 * @see LICENSE.txt
 *
 * This file: Dutch language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Ingebouwd in phpMussel is een URL scanner, het opsporen van kwaadaardige URL\'s vanuit alle gegevens of bestanden gescand. Om de URL scanner te inschakelen, geef de namen van de signature bestanden te gebruiken, gescheiden door komma\'s.';
