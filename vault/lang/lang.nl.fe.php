 ...
 * @see LICENSE.txt
 *
 * This file: Dutch language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_general_cleanup'] = 'Vrijmaken script variabelen en de cache na de uitvoering? False = Nee; True = Ja [Standaard]. Als u niet gebruik het script na de eerste scan van upload, moet zetten op `true` (ja), om minimaliseren de geheugengebruik. Als u gebruik het script voor de doeleinden na de eerste scan van upload, moet zetten op `false` (nee), om te voorkomen dat onnodig herladen dubbele gegevens in het geheugen. In de huisartspraktijk, moet waarschijnlijk worden zetten op `true` (ja), maar, als u dit doet, het zal niet mogelijk zijn om het script te gebruiken voor iets anders dan het scannen van bestand uploaden. Heeft geen invloed in CLI-modus.';
...
$phpMussel['lang']['config_general_FrontEndLog'] = 'Bestand om de front-end login pogingen te loggen. Geef een bestandsnaam, of laat leeg om uit te schakelen.';
...
$phpMussel['lang']['config_signatures_MD5'] = 'Gebruik MD5 signatures bij het scannen? Als dat zo is, geef de namen van de signature bestanden te gebruiken, gescheiden door komma\'s.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Gebruik PE uitgebreide signatures voor de PE-bestanden (EXE, DLL, e.z.v.) bij het scannen? Als dat zo is, geef de namen van de signature bestanden te gebruiken, gescheiden door komma\'s.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Gebruik PE Sectionele signatures voor de PE-bestanden (EXE, DLL, e.z.v.) bij het scannen? Als dat zo is, geef de namen van de signature bestanden te gebruiken, gescheiden door komma\'s.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Ingebouwd in phpMussel is een URL scanner, het opsporen van kwaadaardige URL\'s vanuit alle gegevens of bestanden gescand. Om de URL scanner te inschakelen, zetten de richtlijn `urlscanner` op true; Om het te uitschakelen, zetten dit richtlijn op false.';
