...
$phpMussel['lang']['Extended Description: Chart.js'] = 'Ermöglicht dem Frontend die Generierung von Kreisdiagrammen.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> ist über die <a href="https://opensource.org/licenses/MIT">MIT license</a> verfügbar.';
$phpMussel['lang']['Extended Description: PHPMailer'] = 'Erforderlich für die Verwendung von Funktionen zum Senden von E-Mails.<br /><a href="https://github.com/PHPMailer/PHPMailer">PHPMailer</a> ist über die <a href="https://github.com/PHPMailer/PHPMailer/blob/master/LICENSE">LGPLv2.1</a>-Lizenz verfügbar.';
...
$phpMussel['lang']['config_PHPMailer_Enable2FA'] = 'Diese Direktive bestimmt, ob 2FA für Frontend-Konten verwendet werden soll.';
...
$phpMussel['lang']['config_PHPMailer_addReplyToAddress'] = 'Die Antwortadresse, die beim Senden von E-Mails über SMTP verwendet werden soll.';
$phpMussel['lang']['config_PHPMailer_addReplyToName'] = 'Der Name für der Antwort, die beim Senden von E-Mails über SMTP verwendet werden soll.';
$phpMussel['lang']['config_PHPMailer_setFromAddress'] = 'Die Absenderadresse, die beim Senden von E-Mails über SMTP verwendet werden soll.';
$phpMussel['lang']['config_PHPMailer_setFromName'] = 'Der Name des Absenders, der beim Senden von E-Mails über SMTP verwendet werden soll.';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'Versuchen Sie, alle Dateien die Makros enthalten zu blockieren? Einige Arten von Dokumenten und Tabellen können ausführbare Makros enthalten und somit einen gefährlichen potenziellen Malware-Vektor darstellen. False = Nicht blockieren [Standardeinstellung]; True = Blockieren.';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'Eine Liste von Dateierweiterungen, die PHP-Code enthalten dürfen, getrennt durch Kommas. Wenn die PHP-Chameleon-Angriffserkennung aktiviert ist, werden Dateien mit PHP-Code, die Erweiterungen aufweisen, die nicht in dieser Liste enthalten sind, als PHP-Chameleon-Angriffe erkannt.';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'Identifizieren Sie falsche Header in Archiven und komprimierten Dateien. Unterstützt: BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP. False = Deaktiviert; True = Aktiviert.';
...
$phpMussel['lang']['config_experimental'] = 'Instabil/Experimentell!';
...
$phpMussel['lang']['config_files_check_archives'] = 'Soll der Inhalt von Archiven überprüft werden? False = Nein (keine Überprüfung); True = Ja (wird überprüft) [Standardeinstellung].';
...
$phpMussel['lang']['config_files_max_recursion'] = 'Maximale Grenze der Rekursionstiefe von Archiven. Standardwert = 3.';
...
$phpMussel['lang']['config_general_FrontEndLog'] = 'Datei für die Protokollierung von Frontend Anmelde-Versuchen. Geben Sie einen Dateinamen an oder lassen Sie die Option zum Deaktivieren leer.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Web-Fonts deaktivieren? True = Ja [Standardeinstellung]; False = Nein.';
...
$phpMussel['lang']['config_general_log_rotation_limit'] = 'Die Protokollrotation begrenzt die Anzahl der Protokolldateien, die gleichzeitig vorhanden sein dürfen. Wenn neue Protokolldateien erstellt werden, und wenn die Gesamtzahl der Protokolldateien den angegebenen Limit überschreitet, wird die angegebene Aktion ausgeführt. Sie können hier das gewünschte Limit angeben. Ein Wert von 0 deaktiviert die Protokollrotation.';
$phpMussel['lang']['config_general_maintenance_mode'] = 'Deaktiviert alles andere als das Frontend. Manchmal nützlich für die Aktualisierung Ihrer CMS, Frameworks, u.s.w. Wartungsmodus aktivieren? True = Ja; False = Nein [Standardeinstellung].';
$phpMussel['lang']['config_general_max_login_attempts'] = 'Maximale Anzahl der Versucht zum Anmelden (Frontend). Standardeinstellung = 5.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Die maximale Anzahl von Dateien, die in der Quarantäne vorhanden sein können. Wenn neue Dateien zur Quarantäne hinzugefügt werden, werden alte Dateien gelöscht, wenn diese Anzahl überschritten wird, bis der Rest diese Nummer nicht mehr überschreitet. Standardwert = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'Die Adresse einer relevanten Datenschutz-Bestimmungen, die in der Fußzeile aller generierten Seiten angezeigt werden soll. Geben Sie eine URL ein, oder lassen Sie sie leer, um sie zu deaktivieren.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymisieren IP-Adressen beim Schreiben der Protokolldateien? True = Ja [Standardeinstellung]; False = Nein.';
...
$phpMussel['lang']['field_confirm'] = 'Bestätigen';
...
$phpMussel['lang']['field_verify'] = 'Verifizieren';
$phpMussel['lang']['field_verify_all'] = 'Verifizieren alle';
...
$phpMussel['lang']['label_actual'] = 'Aktuell';
...
$phpMussel['lang']['label_expected'] = 'Erwartet';
$phpMussel['lang']['label_expires'] = 'Läuft ab: ';
...
$phpMussel['lang']['label_fmgr_other_sig'] = 'Andere Regeln, Signaturdateien, u.s.w.';
$phpMussel['lang']['label_fmgr_safety'] = 'Sicherheitsmechanismen';
...
$phpMussel['lang']['label_hide_hash_table'] = 'Hash-tabelle ausblenden';
$phpMussel['lang']['label_never'] = 'Noch nie';
...
$phpMussel['lang']['label_show_hash_table'] = 'Hash-tabelle anzeigen';
...
$phpMussel['lang']['label_your_ip'] = 'Deine IP:';
$phpMussel['lang']['label_your_ua'] = 'Deine UA:';
$phpMussel['lang']['link_accounts'] = 'Konten';
$phpMussel['lang']['link_cache_data'] = 'Datencache';
...
$phpMussel['lang']['response_2fa_invalid'] = 'Falscher 2FA-Code eingegeben. Authentifizierung fehlgeschlagen.';
$phpMussel['lang']['response_2fa_valid'] = 'Erfolgreich authentifiziert.';
...
$phpMussel['lang']['response_possible_problem_found'] = 'Mögliches Problem gefunden.';
...
$phpMussel['lang']['security_warning'] = 'Bei der Verarbeitung Ihrer Anfrage ist ein unerwartetes Problem aufgetreten. Bitte versuche es erneut. Wenn dieses Problem weiterhin besteht, kontaktieren Sie Support.';
...
$phpMussel['lang']['state_email_sent'] = 'E-Mail wurde erfolgreich an "%s" gesendet.';
$phpMussel['lang']['state_failed_missing'] = 'Der Vorgang ist fehlgeschlagen, weil eine erforderliche Komponente nicht verfügbar ist.';
$phpMussel['lang']['state_loading'] = 'Wird geladen...';
$phpMussel['lang']['state_loadtime'] = 'Seite-Anfrage in <span class="txtRd">%s</span> Sekunden abgeschlossen.';
$phpMussel['lang']['state_logged_in'] = 'Eingeloggt.';
$phpMussel['lang']['state_logged_in_2fa_pending'] = 'Eingeloggt + Warten auf 2FA.';
$phpMussel['lang']['state_logged_out'] = 'Ausgeloggt.';
...
$phpMussel['lang']['tip_accounts'] = 'Hallo, {username}.<br />Das Kontenseite macht es möglich zu kontrollieren, wer kann Zugriff auf der phpMussel Frontend haben.';
$phpMussel['lang']['tip_cache_data'] = 'Hallo, {username}.<br />Hier können Sie den Inhalt des Cache überprüfen.';
$phpMussel['lang']['tip_config'] = 'Hallo, {username}.<br />Das Konfigurationsseite macht es möglich zu ändern das Konfiguration für phpMussel von der Frontend.';
...
$phpMussel['lang']['tip_fe_cookie_warning'] = 'Hinweis: phpMussel verwendet einen Cookie zum Authentifizieren von Logins. Mit der Einloggen, Sie sich damit einverstanden, dass ein Cookie von Ihrem Browser erstellt und gespeichert wird.';
...
$phpMussel['lang']['tip_home'] = 'Hallo, {username}.<br />Dies ist die Homepage der phpMussel Frontend. Wählen Sie einen Link aus dem Navigationsmenü auf der linken um fortzufahren.';
...
$phpMussel['lang']['tip_pie_html'] = 'Klicken Sie auf den Komponentennamen, um weitere Informationen zu erhalten.';
...
$phpMussel['lang']['title_login'] = 'Einloggen';
...
$phpMussel['lang']['info_some_useful_links'] = 'Einige nützliche Links:<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – Phishing-Datenbank, die vom phpMussel-URL-Scanner verwendet wird.</li>
      ...
      <li><a href="https://www.hybrid-analysis.com/">Hybrid Analysis</a> – Hybrid Analysis ist ein kostenloser Malware-Analyse-Service von <a href="https://www.payload-security.com/">Payload Security</a> zur Verfügung gestellt.</li>
