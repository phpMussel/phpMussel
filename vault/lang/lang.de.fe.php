 ...
 * @see LICENSE.txt
 *
 * This file: German language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'In phpMussel ist ein URL-Scanner eingebaut, der bösartige URLs in Daten und gescannten Dateien erkennt. Um den URL-Scanner zu aktivieren, geben Sie den Namen der Signaturdateien zu verwendenden, durch Kommas begrenzt.';
