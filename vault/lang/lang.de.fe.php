 ...
 * @see LICENSE.txt
 *
 * This file: German language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_signatures_MD5'] = 'Scan mit den MD5-Signaturen? Wenn ja, geben Sie den Namen der Signaturdateien zu verwendenden, durch Kommas begrenzt.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Scan von PE-Dateien (Portable Executable, EXE, DLL, u.s.w.) mit den PE-Erweitert-Signaturen? Wenn ja, geben Sie den Namen der Signaturdateien zu verwendenden, durch Kommas begrenzt.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Scan von PE-Dateien (Portable Executable, EXE, DLL, u.s.w.) mit den PE-Sectional-Signaturen? Wenn ja, geben Sie den Namen der Signaturdateien zu verwendenden, durch Kommas begrenzt.';
...
$phpMussel['lang']['config_urlscanner_lookup_hphosts'] = 'Aktiviert API-Abfragen zur hpHosts API wenn der Wert auf `true` gesetzt ist.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'In phpMussel ist ein URL-Scanner eingebaut, der bösartige URLs in Daten und gescannten Dateien erkennt. Um den URL-Scanner zu aktivieren, setzen Sie die `urlscanner` Anweisung auf `true`; Um ihn zu deaktivieren, setzen Sie diese Anweisung auf `false`.';
...
$phpMussel['lang']['response_component_update_error'] = 'Beim Aktualisieren der Komponente ist ein Fehler aufgetreten.';
...
$phpMussel['lang']['tip_see_the_documentation'] = 'Siehe die <a href="https://github.com/Maikuolan/phpMussel/blob/master/_docs/readme.de.md#SECTION7">Dokumentation</a> für Informationen über den verschiedenen Konfigurationseinstellungen und ihren Zwecken.';
...
$phpMussel['lang']['info_some_useful_links'] = 'Einige nützliche Links:<ul>
            <li><a href="https://github.com/Maikuolan/phpMussel/issues">phpMussel Issues @ GitHub</a> – Problemseite für phpMussel (Unterstützung, u.s.w.).</li>
