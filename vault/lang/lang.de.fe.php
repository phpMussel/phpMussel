 ...
 * @see LICENSE.txt
 *
 * This file: German language data for the front-end (last modified: 2018.10.16).
 */
...
$phpMussel['lang']['Extended Description: Chart.js'] = 'Ermöglicht dem Front-End die Generierung von Kreisdiagrammen.<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> ist über die <a href="https://opensource.org/licenses/MIT">MIT license</a> verfügbar.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'Die Adresse einer relevanten Datenschutz-Bestimmungen, die in der Fußzeile aller generierten Seiten angezeigt werden soll. Geben Sie eine URL, oder lassen Sie sie leer, um sie zu deaktivieren.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonymisieren IP-Adressen beim Schreiben der Protokolldateien? True = Ja; False = Nein [Standardeinstellung].';
