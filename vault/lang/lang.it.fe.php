 ...
 * @see LICENSE.txt
 *
 * This file: Italian language data for the front-end (last modified: 2016.10.29).
 */
...
$phpMussel['lang']['tip_hello'] = 'Salve, {username}.';
...
$phpMussel['lang']['tip_logs'] = 'Selezionare un file di log dall\'elenco sottostante per visualizzare il contenuto di tale file di log.';
