 ...
 * @see LICENSE.txt
 *
 * This file: Italian language data for the front-end (last modified: 2018.10.16).
 */
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'Prova a bloccare qualsiasi file contenente macro? Alcuni tipi di documenti e fogli di calcolo possono contenere macro eseguibili, fornendo così un pericoloso vettore potenziale di malware. False = Ignorarli; True = Bloccarli [Predefinito].';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'Un elenco di estensioni di file consentito contenere codice PHP, separato da virgole. Se PHP chameleon attacco rilevamento è abilitato, i file che contengono codice PHP, che hanno estensioni non presenti in questo elenco, saranno rilevati come attacchi chameleon di PHP.';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'Rileva le header errate negli archivi e nei file compressi. Supportato: BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP. False = Disattivato; True = Attivato.';
...
$phpMussel['lang']['config_experimental'] = 'Instabile/Sperimentale!';
...
$phpMussel['lang']['config_files_check_archives'] = 'Tenta per verifica il contenuti degli archivi? False = No (no verifica); True = Sì (fare verifica) [Predefinito].';
...
$phpMussel['lang']['config_files_max_recursion'] = 'Massimo ricorsione profondità limite per gli archivi. Predefinito = 3.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'Disabilita webfonts? True = Sì [Predefinito]; False = No.';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'Il numero massimo di file che possono esistere nella quarantena. Quando vengono aggiunti nuovi file alla quarantena, se questo numero viene superato, i file precedenti verranno eliminati fino a quando il resto non supererà più questo numero. Predefinito = 100.';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'L\'indirizzo di una politica sulla privacy pertinente da visualizzare nel piè di pagina delle pagine generate. Specificare un URL, o lasciare vuoto per disabilitare.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'Pseudonimizzare gli indirizzi IP durante la scrivono i file di registro? True = Sì; False = No [Predefinito].';
...
$phpMussel['lang']['field_confirm'] = 'Confermare';
...
$phpMussel['lang']['field_verify'] = 'Verificarlo';
$phpMussel['lang']['field_verify_all'] = 'Verifica tutto';
...
$phpMussel['lang']['label_actual'] = 'Effettivo';
$phpMussel['lang']['label_backup_location'] = 'Posizioni di backup del repository (in caso di emergenza, o se tutto il resto fallisce):';
$phpMussel['lang']['label_blocked'] = 'Caricamenti bloccati';
$phpMussel['lang']['label_branch'] = 'Branch più recente stabile:';
$phpMussel['lang']['label_clientinfo'] = 'Informazioni sul cliente:';
$phpMussel['lang']['label_events'] = 'Scansioni eventi';
$phpMussel['lang']['label_expected'] = 'Previsto';
$phpMussel['lang']['label_expires'] = 'Scade: ';
...
$phpMussel['lang']['label_hide_hash_table'] = 'Nascondi tabella hash';
$phpMussel['lang']['label_never'] = 'Mai';
...
$phpMussel['lang']['label_show_hash_table'] = 'Mostra tabella hash';
...
$phpMussel['lang']['label_your_ip'] = 'Il tuo IP:';
$phpMussel['lang']['label_your_ua'] = 'Il tuo UA:';
$phpMussel['lang']['link_accounts'] = 'Utenti';
$phpMussel['lang']['link_cache_data'] = 'Dati della Cache';
...
$phpMussel['lang']['response_2fa_invalid'] = 'Codice 2FA errato inserito. Autenticazione fallita.';
$phpMussel['lang']['response_2fa_valid'] = 'Autenticato con successo.';
...
$phpMussel['lang']['response_possible_problem_found'] = 'Possibile problema riscontrato.';
...
$phpMussel['lang']['security_warning'] = 'Si è verificato un problema imprevisto durante l\'elaborazione della richiesta. Per favore riprova. Se i problemi persistono, ottenere aiuto dal supporto.';
...
$phpMussel['lang']['title_login'] = 'Accedi';
...
$phpMussel['lang']['msg_template_2fa'] = '<center><p>Salve, %1$s.<br />
<br />
...
$phpMussel['lang']['msg_subject_2fa'] = 'Autenticazione a due fattori';
