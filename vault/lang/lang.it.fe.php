 ...
 * @see LICENSE.txt
 *
 * This file: Italian language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'Costruito in phpMussel è un URL scanner, in grado di rilevare URL malevoli all\'interno di dati ei file scansionati. Per abilitare l\'URL scanner, specificare i nomi dei file di firme da utilizzare, delimitati da virgole.';
