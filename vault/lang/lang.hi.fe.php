 ...
 * @see LICENSE.txt
 *
 * This file: Hindi language data for the front-end (last modified: 2018.10.16).
 */
...
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'लॉग फाइल लिखते समय pseudonymize IP पते? True(सच्चे) = हाँ; False(झूठी) = नहीं [डिफ़ॉल्ट]।';
