...
$phpMussel['lang']['Extended Description: Chart.js'] = 'पाई चार्ट उत्पन्न करने के लिए सामने के अंत सक्षम करता है।<br /><a href="https://github.com/chartjs/Chart.js">Chart.js</a> <a href="https://opensource.org/licenses/MIT">MIT license</a> के माध्यम से उपलब्ध है।';
...
$phpMussel['lang']['config_PHPMailer_Enable2FA'] = 'यह निर्देश निर्धारित करता है कि सामने के अंत खाते 2FA का उपयोग करते हैं या नहीं।';
$phpMussel['lang']['config_PHPMailer_EventLog'] = 'PHPMailer के संबंध में सभी घटनाओं को लॉग इन करने के लिए एक फ़ाइल। एक फाइल नाम निर्दिष्ट करें, या निष्क्रिय करने के लिए खाली छोड़।';
$phpMussel['lang']['config_PHPMailer_Host'] = 'आउटबाउंड ईमेल के लिए उपयोग करने के लिए SMTP होस्ट।';
$phpMussel['lang']['config_PHPMailer_Password'] = 'ईमेल भेजते समय उपयोग करने के लिए पासवर्ड।';
$phpMussel['lang']['config_PHPMailer_Port'] = 'आउटबाउंड ईमेल के लिए उपयोग करने के लिए पोर्ट नंबर। डिफ़ॉल्ट = "587"।';
$phpMussel['lang']['config_PHPMailer_SMTPAuth'] = 'यह निर्देश निर्धारित करता है कि SMTP सत्र प्रमाणित करना है या नहीं (आपको आमतौर पर इसे अकेला छोड़ देना चाहिए)।';
$phpMussel['lang']['config_PHPMailer_SMTPSecure'] = 'ईमेल भेजने के दौरान उपयोग करने के लिए प्रोटोकॉल (TLS या SSL)।';
...
$phpMussel['lang']['config_PHPMailer_Username'] = 'ईमेल भेजने समय उपयोग करने के लिए उपयोगकर्ता नाम।';
$phpMussel['lang']['config_PHPMailer_addReplyToAddress'] = 'ईमेल भेजने के लिए उत्तर पता।';
$phpMussel['lang']['config_PHPMailer_addReplyToName'] = 'ईमेल भेजने के लिए उत्तर का नाम।';
$phpMussel['lang']['config_PHPMailer_setFromAddress'] = 'ईमेल भेजने के लिए प्रेषक पता।';
$phpMussel['lang']['config_PHPMailer_setFromName'] = 'ईमेल भेजने के लिए प्रेषक का नाम।';
...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'मैक्रोज़ युक्त किसी भी फाइल को ब्लॉक करने का प्रयास करें? कुछ प्रकार के दस्तावेज़ और स्प्रेडशीट में निष्पादन योग्य मैक्रोज़ हो सकते हैं, इस प्रकार एक खतरनाक संभावित मैलवेयर वेक्टर प्रदान करते हैं। False(झूठी) = ब्लॉक न करें [डिफ़ॉल्ट]; True(सच्चे) = ब्लॉक करें।';
$phpMussel['lang']['config_attack_specific_can_contain_php_file_extensions'] = 'फ़ाइल एक्सटेंशन की एक सूची PHP कोड रखने की अनुमति है, कॉमा द्वारा अलग। यदि PHP गिरगिट हमले का पता लगाने सक्षम है, जिन फ़ाइलों में PHP कोड है, जिनमें एक्सटेंशन हैं जो इस सूची में नहीं हैं, को PHP गिरगिट के हमलों के रूप में पहचाना जाएगा।';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_archive'] = 'अभिलेखागार और संपीड़ित फ़ाइलों में गलत शीर्षलेख खोजें। समर्थित: BZ/BZIP2, GZ/GZIP, LZF, RAR, ZIP। False(झूठी) = अक्षम; True(सच्चे) = सक्षम।';
...
$phpMussel['lang']['config_experimental'] = 'अस्थिर/प्रायोगिक!';
...
$phpMussel['lang']['config_files_check_archives'] = 'अभिलेखागार की सामग्री की जांच करने का प्रयास? False(झूठी) = उन्हें जांच न करें; True(सच्चे) = उन्हें जांच [डिफ़ॉल्ट]।';
...
$phpMussel['lang']['config_files_max_recursion'] = 'अभिलेखागार के लिए अधिकतम पुनरावर्ती गहराई सीमा। डिफ़ॉल्ट = 3.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'निष्क्रिय वेब फोंट? True(सच्चे) = हाँ [डिफ़ॉल्ट]; False(झूठी) = नहीं।';
...
$phpMussel['lang']['config_general_log_rotation_action'] = 'लॉग रोटेशन लॉगफाइल की संख्या को सीमित करता है जो कि किसी भी समय मौजूद होना चाहिए। जब नई लॉगफाइल बनाई जाती हैं, यदि लॉगफाइल की कुल संख्या निर्दिष्ट सीमा से अधिक है, तो निर्दिष्ट कार्रवाई की जाएगी। आप यहां वांछित कार्रवाई निर्दिष्ट कर सकते हैं। Delete = सबसे पुरानी लॉगफाइल हटाएं, जब तक कि सीमा अब पार न हो जाए। Archive = सबसे पहले संग्रहित करें, और तब सबसे पुरानी लॉगफाइल हटाएं, जब तक कि सीमा अब पार न हो जाए।';
$phpMussel['lang']['config_general_log_rotation_limit'] = 'लॉग रोटेशन लॉगफाइल की संख्या को सीमित करता है जो कि किसी भी समय मौजूद होना चाहिए। जब नई लॉगफाइल बनाई जाती हैं, यदि लॉगफाइल की कुल संख्या निर्दिष्ट सीमा से अधिक है, तो निर्दिष्ट कार्रवाई की जाएगी। आप यहां वांछित सीमा निर्दिष्ट कर सकते हैं। 0 का मान लॉग रोटेशन अक्षम कर देगा।';
...
$phpMussel['lang']['config_general_quarantine_max_files'] = 'क्वारंटाइन में मौजूद फाइलों की अधिकतम संख्या। जब क्वारंटाइन में नई फाइलें जोड़ दी जाती हैं, यदि यह संख्या पार हो जाती है, तो पुरानी फाइलें तब तक हटा दी जाएंगी जब तक शेष शेष इस संख्या से अधिक न हो जाए। डिफ़ॉल्ट = "100"।';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'किसी भी जेनरेट किए गए पृष्ठों के पाद लेख में प्रदर्शित होने वाली प्रासंगिक गोपनीयता नीति का पता। एक URL निर्दिष्ट करें, या अक्षम करने के लिए खाली छोड़ दें।';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'लॉग फाइल लिखते समय pseudonymize IP पते? True(सच्चे) = हाँ [डिफ़ॉल्ट]; False(झूठी) = नहीं।';
...
$phpMussel['lang']['field_confirm'] = 'की पुष्टि करें';
...
$phpMussel['lang']['label_fmgr_other_sig'] = 'अन्य नियम, हस्ताक्षर फाइलें, आदि';
$phpMussel['lang']['label_fmgr_safety'] = 'सुरक्षा तंत्र';
...
$phpMussel['lang']['response_2fa_invalid'] = 'गलत 2FA कोड दर्ज किया गया। प्रमाणीकरण विफल होना।';
$phpMussel['lang']['response_2fa_valid'] = 'सफलतापूर्वक प्रमाणीकृत।';
...
$phpMussel['lang']['tip_cache_data'] = 'हैलो, {username}।<br />यहां आप कैश की सामग्रियों की समीक्षा कर सकते हैं।';
...
$phpMussel['lang']['tip_pie_html'] = 'अधिक विवरण के लिए घटक नाम पर क्लिक करें।';
...
$phpMussel['lang']['info_some_useful_links'] = 'कुछ उपयोगी लिंक:<ul>
      ...
      <li><a href="https://www.phishtank.com/">PhishTank</a> – phpMussel यूआरएल स्कैनर द्वारा उपयोग किए गए फ़िशिंग डेटाबेस।</li>
      ...
      <li><a href="https://www.hybrid-analysis.com/">Hybrid Analysis</a> – Hybrid Analysis <a href="https://www.payload-security.com/">Payload Security</a> द्वारा प्रदान की जाने वाली एक मुफ्त मैलवेयर विश्लेषण सेवा है।</li>
...
$phpMussel['lang']['msg_subject_2fa'] = 'दो तरीकों से प्रमाणीकरण';
