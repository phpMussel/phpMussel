 ...
 * @see LICENSE.txt
 *
 * This file: Arabic language data (last modified: 2016.05.11).
 *
 * @todo English->Arabic i18n not yet done, but a translator is currently working it (supposedly..? time will tell).
 */
