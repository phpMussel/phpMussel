 ...
 * @see LICENSE.txt
 *
 * This file: Arabic language data (last modified: 2016.08.09).
 *
 * @todo Incomplete.
 */

$phpMussel['Config']['lang']['textDir'] = 'rtl';
$phpMussel['Config']['lang']['bad_command'] = 'أنا لا أفهم هذا الأمر، آسف.';
$phpMussel['Config']['lang']['cli_failed_to_complete'] = 'فشل في إكمال عملية المسح.';
$phpMussel['Config']['lang']['cli_is_not_a'] = ' ليس ملف أو مجلد.';
...
$phpMussel['Config']['lang']['cli_pe1'] = 'ليس ملف PE صالح!';
$phpMussel['Config']['lang']['cli_pe2'] = 'أقسام PE:';
$phpMussel['Config']['lang']['cli_working'] = 'في تَقَدم';
...
$phpMussel['Config']['lang']['corrupted'] = 'الكشف PE تلف';
...
$phpMussel['Config']['lang']['denied_reason'] = 'تم حجب التحميل للأسباب الواردة أدناه:';
$phpMussel['Config']['lang']['detected'] = 'الكشف {vn}';
...
$phpMussel['Config']['lang']['failed_to_access'] = 'فشل الوصول إلى ';
$phpMussel['Config']['lang']['file'] = 'ملف';
...
$phpMussel['Config']['lang']['finished'] = 'انتهى';
$phpMussel['Config']['lang']['generated_by'] = 'الناتج';
...
$phpMussel['Config']['lang']['image'] = 'صورة';
...
$phpMussel['Config']['lang']['quarantined_as'] = "الحجر الصحي بأنه \"/vault/quarantine/{QFU}.qfu\".\n";
$phpMussel['Config']['lang']['recursive'] = 'Recursion depth limit exceeded';
$phpMussel['Config']['lang']['required_variables_not_defined'] = 'Required variables aren\'t defined: لا يمكن أن يستمر.';
$phpMussel['Config']['lang']['SafeBrowseLookup_200'] = 'يحتمل أن تكون ضارة URL الكشف';
$phpMussel['Config']['lang']['SafeBrowseLookup_400'] = 'API request error';
$phpMussel['Config']['lang']['SafeBrowseLookup_401'] = 'API authorisation error';
$phpMussel['Config']['lang']['SafeBrowseLookup_503'] = 'API service unavailable';
$phpMussel['Config']['lang']['SafeBrowseLookup_999'] = 'Unknown API error';
...
$phpMussel['Config']['lang']['scan_reading'] = 'قراءة';
...
$phpMussel['Config']['lang']['started'] = 'بدأت';
$phpMussel['Config']['lang']['too_many_urls'] = 'عدد كبير جدا من عناوين المواقع';
...
$phpMussel['Config']['lang']['wrong_password'] = 'كلمة مرور خاطئة؛ رفض العمل.';
$phpMussel['Config']['lang']['x_does_not_exist'] = 'غير موجود';
