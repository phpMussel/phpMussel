 ...
 * @see LICENSE.txt
 *
 * This file: English language data (last modified: 2016.05.20).
 */
...
$phpMussel['Config']['lang']['denied_other'] = 'Téléchargement Refusé! Subida Denegada! Caricamento Negato! Upload verweigert! Upload Geweigerd! アップロード拒否! 上传是否认! 上傳是否認! Uppladda Nekas! Загрузка Отказана! Augšupielādēt Liegta! 업로드 거부! Sự tải lên đã bị từ chối!';
...
$phpMussel['Config']['lang']['quarantined_as'] = "Quarantined as \"/vault/quarantine/{QFU}.qfu\".\n";
...
$phpMussel['Config']['lang']['SafeBrowseLookup_200'] = 'Potentially harmful URL detected';
