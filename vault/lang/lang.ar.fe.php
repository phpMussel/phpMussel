...
$phpMussel['lang']['config_attack_specific_block_macros'] = 'حاول حظر أي ملفات تحتوي على وحدات ماكرو؟ قد تحتوي بعض أنواع المستندات وجداول البيانات على وحدات ماكرو قابلة للتنفيذ، وبالتالي توفير ناقلات برامج ضارة محتملة خطيرة. زائفة/False = لا تمنع [افتراضي]. صحيح/True = تمنع.';
...
$phpMussel['lang']['config_attack_specific_chameleon_to_doc'] = 'البحث عن المستندات التي عناوينها غير صحيحة (المدعومة: DOC، وزارة النقل، PPS، PPT، XLA، XLS، WIZ). صحيح/True = على. زائفة/False = إيقاف.';
$phpMussel['lang']['config_attack_specific_chameleon_to_img'] = 'البحث عن الصور التي عناوينها غير صحيحة (المدعومة: BMP، DIB، PNG، GIF، JPEG، JPG، XCF، PSD، PDD، WEBP). صحيح/True = على. زائفة/False = إيقاف.';
$phpMussel['lang']['config_attack_specific_chameleon_to_pdf'] = 'البحث عن الملفات PDF التي عناوينها غير صحيحة. صحيح/True = على. زائفة/False = إيقاف.';
...
$phpMussel['lang']['config_compatibility_only_allow_images'] = 'إذا كنت تتوقع فقط أو تنوي فقط للسماح الصور المراد تحميلها على النظام الخاص بك أو CMS، وإذا كنت على الاطلاق لا تتطلب أية ملفات أخرى من الصور ليتم تحميلها على النظام الخاص بك أو CMS، ينبغي تمكين هذا التوجيه، ولكن ينبغي خلاف ذلك يتم تعطيل. إذا تم تمكين هذا التوجيه، أنه سوف يكلف phpMussel لمنع عشوائيا أي الإضافات التي تم تحديدها كملفات صورة غير، دون مسحها. هذا قد يقلل من الوقت اللازم لتجهيز واستخدام الذاكرة لمحاولة تحميل الملفات غير الصورة. زائفة/False = OFF؛ صحيح/True = ON.';
$phpMussel['lang']['config_experimental'] = 'غير مستقر / التجريبي!';
...
$phpMussel['lang']['config_files_check_archives'] = 'محاولة للتحقق من محتويات المحفوظات؟ = كاذبة لا تحقق. صحيح/True = افحص [افتراضي]. في الوقت الراهن، يتم اعتماد فحص فقط من BZ/BZIP2، GZ/GZIP، LZF، PHAR، TAR و ZIP (فحص من RAR، CAB، 7Z وإلى آخره غير معتمدة حاليا). هذه ليست مضمونة! بينما أنا أوصي حفظ هذا قيد التشغيل، لا يمكنني ان اضمن انها سوف تجد دائما كل شيء. أيضا أن ندرك أن أرشيف التحقق حاليا ليست متكررة ملفات PHAR أو ZIP.';
$phpMussel['lang']['config_files_filesize_archives'] = 'ترحيل حجم ملف القائمة السوداء / قائمة بيضاء لمحتويات المحفوظات؟ زائفة/False = لا (فقط كل ما يدرجون)؛ صحيح/True = نعم [افتراضي].';
...
$phpMussel['lang']['config_files_filesize_response'] = 'ماذا تفعل مع الملفات التي تتجاوز الحد الأقصى لحجم الملف (إن وجد). زائفة/False = القائمة البيضاء. صحيح/True = القائمة السوداء [افتراضي].';
$phpMussel['lang']['config_files_filetype_archives'] = 'ترحيل نوع الملف القائمة السوداء / القائمة البيضاء لمحتويات المحفوظات؟ زائفة/False = لا (فقط كل ما يدرجون) [افتراضي]. صحيح/True = نعم.';
...
$phpMussel['lang']['config_general_allow_symlinks'] = 'في بعض الأحيان، لا يتمكن phpMussel من الوصول إلى ملف مباشرةً عندما يتم تسميته بطريقة معينة. يمكن أن يؤدي الوصول إلى الملف بشكل غير مباشر عن طريق symlinks في بعض الأحيان إلى حل هذه المشكلة. ومع ذلك، هذا ليس دائمًا حلًا قابلاً للتطبيق، لأنه في بعض الأنظمة، قد يتم حظر استخدام symlinks، أو قد يتطلب امتيازات إدارية. يتم استخدام هذا التوجيه لتحديد ما إذا كان يجب على phpMussel محاولة استخدام روابط symlinks للوصول إلى الملفات بشكل غير مباشر، عند الوصول إليها مباشرة غير ممكن. صحيح/True = تمكين symlinks؛ زائفة/False = تعطيل symlinks [الافتراضي].';
...
$phpMussel['lang']['config_general_disable_cli'] = 'وضع تعطيل CLI؟ يتم تمكين وضع CLI افتراضيا، ولكن يمكن أن تتداخل أحيانا مع بعض أدوات الاختبار (مثل PHPUnit، على سبيل المثال) وغيرها من التطبيقات القائمة على المبادرة القطرية. إذا كنت لا تحتاج إلى تعطيل وضع CLI، يجب تجاهل هذا التوجيه. خطأ = تمكين وضع CLI [الافتراضي]. صحيح/True = وضع تعطيل CLI.';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'هل تريد تعطيل ويبفونتس؟ صحيح/True = نعم [افتراضي]؛ زائفة/False = لا.';
$phpMussel['lang']['config_general_enable_plugins'] = 'تمكين دعم ملحقات phpMussel؟ زائفة/False = لا؛ صحيح/True = نعم [الافتراضي].';
$phpMussel['lang']['config_general_forbid_on_block'] = 'هل phpMussel يرسل 403 من العناوين مع الرسالة منعت إيداع الملف، أو يبقى مع المعتادة 200 موافق؟ خطأ = رقم (200). صحيح/True = نعم (403) [الافتراضي].';
...
$phpMussel['lang']['config_general_log_rotation_action'] = 'يحدد تدوير السجل عدد ملفات السجل التي يجب أن تكون موجودة في أي وقت. عند إنشاء ملفات السجل الجديدة، إذا تجاوز العدد الإجمالي لبيانات السجل الحد المحدد، فسيتم تنفيذ الإجراء المحدد. يمكنك تحديد الإجراء المطلوب هنا. Delete = احذف أقدم السجلات، حتى لا يتم تجاوز الحد. Archive = أرشفة أولاً، ثم احذف أقدم السجلات، حتى لا يتم تجاوز الحد.';
$phpMussel['lang']['config_general_log_rotation_limit'] = 'يحدد تدوير السجل عدد ملفات السجل التي يجب أن تكون موجودة في أي وقت. عند إنشاء ملفات السجل الجديدة، إذا تجاوز العدد الإجمالي لبيانات السجل الحد المحدد، فسيتم تنفيذ الإجراء المحدد. يمكنك تحديد الحد المرغوب هنا. ستعمل القيمة 0 على تعطيل تدوير السجل.';
$phpMussel['lang']['config_general_maintenance_mode'] = 'هل تريد تمكين وضع الصيانة؟ صحيح/True = نعم؛ زائفة/False = لا [افتراضي]. تعطيل كل شيء بخلاف front-end. قد تكون مفيدة أحيانا عند تحديث نظام إدارة المحتوى والأطر وما إلى ذلك.';
...
$phpMussel['lang']['config_general_statistics'] = 'هل تريد تتبع إحصاءات استخدام phpMussel؟ صحيح/True = نعم؛ زائفة/False = لا [افتراضي].';
...
$phpMussel['lang']['config_legal_privacy_policy'] = 'عنوان سياسة الخصوصية ذات الصلة ليتم عرضها في تذييل الصفحات التي تم إنشاؤها. حدد عنوان URL، أو اتركه فارغًا لتعطيله.';
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'إخفاء عناوين IP عند كتابة السجلات؟ صحيح/True = نعم؛ زائفة/False = لا [افتراضي].';
$phpMussel['lang']['config_signatures_Active'] = 'قائمة من الملفات توقيع النشطة، محدد بفواصل.';
$phpMussel['lang']['config_signatures_detect_adware'] = 'هل يجب على توقيعات phpMussel الكشف عن تجسس؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
$phpMussel['lang']['config_signatures_detect_deface'] = 'هل يجب على توقيعات phpMussel الكشف عن مهاجمات وdefacers؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
$phpMussel['lang']['config_signatures_detect_encryption'] = 'يجب phpMussel كشف ومنع الملفات المشفرة؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
$phpMussel['lang']['config_signatures_detect_joke_hoax'] = 'هل يجب على توقيعات phpMussel الكشف عن خدعة البرمجيات الخبيثة / الفيروسات؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
$phpMussel['lang']['config_signatures_detect_packer_packed'] = 'هل يجب على توقيعات phpMussel الكشف عن تعبئة والبيانات المعبأة؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
$phpMussel['lang']['config_signatures_detect_pua_pup'] = 'هل يجب على توقيعات phpMussel الكشف عن PUAs؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
$phpMussel['lang']['config_signatures_detect_shell'] = 'هل يجب على توقيعات phpMussel الكشف عن البرامج النصية قذيفة؟ زائفة/False = لا؛ صحيح/True = نعم [افتراضي].';
...
$phpMussel['lang']['config_urlscanner_maximum_api_lookups_response'] = 'ماذا تفعل إذا تم تجاوز الحد الأقصى المسموح به من عمليات بحث API؟ = كاذبة لا تفعل شيئا (متابعة المعالجة) [افتراضي]. صحيح/True = تحديد الملف.';
...
$phpMussel['lang']['field_confirm'] = 'تؤكد';
...
$phpMussel['lang']['response_2fa_invalid'] = 'تم إدخال رمز 2FA غير صحيح. المصادقة فشلت.';
$phpMussel['lang']['response_2fa_valid'] = 'تمت المصادقة بنجاح.';
