 ...
 * @see LICENSE.txt
 *
 * This file: Arabic language data for the front-end (last modified: 2017.02.10).
 */
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'مدمج في phpMussel هو ماسح URL، قادر على الكشف عن عناوين المواقع الخبيثة من داخل أي بيانات أو ملفات تم فحصها. لتمكين الماسح URL، تحديد أسماء الملفات توقيع لاستخدام، مفصولة بفواصل.';
