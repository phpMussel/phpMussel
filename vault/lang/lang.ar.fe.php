 ...
 * @see LICENSE.txt
 *
 * This file: Arabic language data for the front-end (last modified: 2017.02.07).
 */
...
$phpMussel['lang']['config_signatures_MD5'] = 'تحقق على التوقيعات MD5 أثناء الفحص؟ لو ذلك، تحديد أسماء الملفات توقيع لاستخدام، مفصولة بفواصل.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'تحقق PE الملفات (محمول الملف التنفيذي) (EXE، DLL، الخ) على التوقيعات طويلة PE أثناء الفحص؟ ذلك، تحديد أسماء الملفات توقيع لاستخدام، مفصولة بفواصل.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'تحقق PE (الملف التنفيذي المحمولة) ملفات (EXE، DLL، الخ) على التوقيعات PE الاقسام أثناء الفحص؟ ذلك، تحديد أسماء الملفات توقيع لاستخدام، مفصولة بفواصل.';
...
$phpMussel['lang']['config_urlscanner_urlscanner'] = 'مدمج في phpMussel هو ماسح URL، قادر على الكشف عن عناوين المواقع الخبيثة من داخل أي بيانات أو ملفات تم فحصها. لتمكين الماسح URL، تعيين "urlscanner" التوجيه إلى صحيح. لتعطيله، تعيين هذا التوجيه إلى خطأ.';
