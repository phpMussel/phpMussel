 ...
 * @see LICENSE.txt
 *
 * This file: Arabic language data for the front-end (last modified: 2018.06.26).
 */
...
$phpMussel['lang']['config_general_allow_symlinks'] = 'في بعض الأحيان، لا يتمكن phpMussel من الوصول إلى ملف مباشرةً عندما يتم تسميته بطريقة معينة. يمكن أن يؤدي الوصول إلى الملف بشكل غير مباشر عن طريق symlinks في بعض الأحيان إلى حل هذه المشكلة. ومع ذلك، هذا ليس دائمًا حلًا قابلاً للتطبيق، لأنه في بعض الأنظمة، قد يتم حظر استخدام symlinks، أو قد يتطلب امتيازات إدارية. يتم استخدام هذا التوجيه لتحديد ما إذا كان يجب على phpMussel محاولة استخدام روابط symlinks للوصول إلى الملفات بشكل غير مباشر، عند الوصول إليها مباشرة غير ممكن. True = تمكين symlinks؛ False = تعطيل symlinks [الافتراضي].';
...
$phpMussel['lang']['config_general_disable_webfonts'] = 'هل تريد تعطيل ويبفونتس؟ True = نعم [افتراضي]؛ False = لا.';
...
$phpMussel['lang']['config_legal_pseudonymise_ip_addresses'] = 'إخفاء عناوين IP عند كتابة السجلات؟ True = نعم؛ False = لا [افتراضي].';
