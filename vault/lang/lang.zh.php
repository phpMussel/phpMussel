 ...
 * @see LICENSE.txt
 *
 * This file: Chinese (simplified) language data (last modified: 2016.08.07).
 */
...
$phpMussel['Config']['lang']['denied_other'] = 'Upload Denied! Téléchargement Refusé! Subida Denegada! Caricamento Negato! Upload verweigert! Upload Geweigerd! アップロード拒否! 上傳是否認! Uppladda Nekas! Загрузка Отказана! Augšupielādēt Liegta! 업로드 거부! Sự tải lên đã bị từ chối!';
...
$phpMussel['Config']['lang']['SafeBrowseLookup_400'] = 'API请求错误';
$phpMussel['Config']['lang']['SafeBrowseLookup_401'] = 'API授权错误';
$phpMussel['Config']['lang']['SafeBrowseLookup_503'] = 'API服务不可用';
$phpMussel['Config']['lang']['SafeBrowseLookup_999'] = '未知API错误';
