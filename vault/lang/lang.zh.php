...
$phpMussel['lang']['cli_ln2'] = "谢谢对于使用phpMussel，一个PHP脚本旨在检测木马，病毒，恶意软件，和其他威胁在文件上传到您的系统随地这个脚本是叫，根据ClamAV的签名和其他签名。\n\n PHPMUSSEL版权2013和此后GNU/GPLv.2通过Caleb M （Maikuolan）。\n\n                                     ~ ~ ~\n\n";
...
$phpMussel['lang']['phpmussel_disabled'] = 'phpMussel关闭。';
$phpMussel['lang']['phpmussel_disabled_already'] = 'phpMussel已关闭。';
