 ...
 * @see LICENSE.txt
 *
 * This file: German language data (last modified: 2016.08.07).
 */
...
$phpMussel['Config']['lang']['denied_other'] = 'Upload Denied! Téléchargement Refusé! Subida Denegada! Caricamento Negato! Upload Geweigerd! アップロード拒否! 上传是否认! 上傳是否認! Uppladda Nekas! Загрузка Отказана! Augšupielādēt Liegta! 업로드 거부! Sự tải lên đã bị từ chối!';
...
$phpMussel['Config']['lang']['quarantined_as'] = "Als \"/vault/quarantine/{QFU}.qfu\" unter Quarantäne gestellt.\n";
...
$phpMussel['Config']['lang']['SafeBrowseLookup_200'] = 'Potentiell schädliche URL entdeckt';
$phpMussel['Config']['lang']['SafeBrowseLookup_400'] = 'API-Anforderungsfehler';
$phpMussel['Config']['lang']['SafeBrowseLookup_401'] = 'API-Berechtigungsfehler';
$phpMussel['Config']['lang']['SafeBrowseLookup_503'] = 'API-Dienst nicht verfügbar';
$phpMussel['Config']['lang']['SafeBrowseLookup_999'] = 'Unbekannt API-Fehler';
