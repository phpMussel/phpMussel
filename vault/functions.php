 ...
 */
$phpMussel['ParseVars'] = function (array $Needles, string $Haystack): string {
    if (empty($Haystack)) {
        return '';
    }
 ...
 */
$phpMussel['Request'] = function (string $URI, $Params = [], int $Timeout = -1, array $Headers = [], int $Depth = 0) use (&$phpMussel): string {
