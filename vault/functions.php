 ...
 * representing "1" (or "on"). `$phpMussel['explode_bits']()` is the reverse of
 ...
 * and "true" representing "1" (or "on"). `$phpMussel['implode_bits']()` is the
 * reverse of `$phpMussel['explode_bits']()`.
 *
