...
class PdfHandler extends ArchiveHandler
{
    ...
    public function EntryRead($Bytes = -1)
    {
        ...
        return isset($this->Objects[$this->Index]['Data']) ? $this->Objects[$this->Index]['Data'] : '';
    }
    ...
    public function EntryCompressedSize()
    {
        return isset($this->Objects[$this->Index]['EntryCompressedSize']) ? $this->Objects[$this->Index]['EntryCompressedSize'] : 0;
    }
    ...
    public function EntryActualSize()
    {
        return isset($this->Objects[$this->Index]['EntryActualSize']) ? $this->Objects[$this->Index]['EntryActualSize'] : 0;
    }
