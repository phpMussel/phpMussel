 ...
 "LICENSE.txt" в прилагаемых к нему документах "_docs", а также на страницах:
 ...
 /_docs/change_log.txt (Документация, Включены)
    ...
    ~
 /_docs/readme.ar.md (Документация, Включены); Арабском языке
 /_docs/readme.de.md (Документация, Включены); Немецком языке
 /_docs/readme.de.txt (Документация, Включены); Немецком языке
 /_docs/readme.en.md (Документация, Включены); Английском языке
 /_docs/readme.en.txt (Документация, Включены); Английском языке
 /_docs/readme.es.md (Документация, Включены); Испанском языке
 /_docs/readme.es.txt (Документация, Включены); Испанском языке
 /_docs/readme.fr.md (Документация, Включены); Французском языке
 /_docs/readme.fr.txt (Документация, Включены); Французском языке
 /_docs/readme.id.md (Документация, Включены); Индонезийском языке
 /_docs/readme.id.txt (Документация, Включены); Индонезийском языке
 /_docs/readme.it.md (Документация, Включены); Итальянском языке
 /_docs/readme.it.txt (Документация, Включены); Итальянском языке
 /_docs/readme.nl.md (Документация, Включены); Нидерланском языке
 /_docs/readme.nl.txt (Документация, Включены); Нидерланском языке
 /_docs/readme.pt.md (Документация, Включены); Португальском языке
 /_docs/readme.pt.txt (Документация, Включены); Португальском языке
 /_docs/readme.ru.md (Документация, Включены); Русском языке
 /_docs/readme.ru.txt (Документация, Включены); Русском языке
 /_docs/readme.vi.md (Документация, Включены); Вьетнамском языке
 /_docs/readme.vi.txt (Документация, Включены); Вьетнамском языке
 /_docs/readme.zh.md (Документация, Включены); Китайском упрощенный
 /_docs/readme.zh-TW.md (Документация, Включены); Китайском традиционный
 ...
 /_testfiles/graphics_standard_testfile.gif (Тестовый файл, Включены)
    ...
    ~
 /_testfiles/html_standard_testfile.html (Тестовый файл, Включены)
 ...
 /vault/cache/.htaccess (Другой, Включены)
    Гипертекст доступа файл (в этом случае защищает от неавторизованного
    доступа чувствительные файлы данного руководства).
    ~
 /vault/lang/ (Регистр)
 ...
 /vault/lang/.htaccess (Другой, Включены)
    ...
    доступа чувствительные файлы данного руководства).
    ~
 /vault/lang/lang.ar.inc (Script, Включены); Арабском языке
 /vault/lang/lang.de.inc (Script, Включены); Немецком языке
 /vault/lang/lang.en.inc (Script, Включены); Английском языке
 /vault/lang/lang.es.inc (Script, Включены); Испанском языке
 /vault/lang/lang.fr.inc (Script, Включены); Французском языке
 /vault/lang/lang.id.inc (Script, Включены); Индонезийском языке
 /vault/lang/lang.it.inc (Script, Включены); Итальянском языке
 /vault/lang/lang.ja.inc (Script, Включены); Японском языке
 /vault/lang/lang.nl.inc (Script, Включены); Нидерланском языке
 /vault/lang/lang.pt.inc (Script, Включены); Португальском языке
 /vault/lang/lang.ru.inc (Script, Включены); Русском языке
 /vault/lang/lang.vi.inc (Script, Включены); Вьетнамском языке
 /vault/lang/lang.zh.inc (Script, Включены); Китайском упрощенный языке
 /vault/lang/lang.zh-TW.inc (Script, Включены); Китайском традиционный языке
 ...
 /vault/scan_log.txt *(Журнальный файл, Создан)
    ...
    ~
 /vault/scan_log_serialized.txt *(Журнальный файл, Создан)
    Опись всех просканированных phpMussel объектов.
    ~
 ...
 * Название файла может варьироваться, в зависимости от конфигурации в
 ...
 - Генеральная конфигурация от phpMussel.
    ...
    "scan_log_serialized"
    - Название файла, в который записываются результаты всех контрольных
      проверок (сериализовано Формат). Задайте имя файлу или оставьте пустым,
      чтобы деактивировать опцию.
    "scan_kills"
    ...
    - Возвращённый 403-HTTP-заголовок при заблокированной загрузке данных.
      False = Нет (200) [Стандарт]; True = Да (403).
    "delete_on_sight"
    ...
    - При активированном Honeypot-модуса phpMussel изолирует каждый загружаемый
      ...
      False = Деактивировано [стандартное значение]; True = Активировано.
    "scan_cache_expiry"
    ...
    - Деактивировать ли CLI-модус? Обычно CLI-модус активирован. Однако иногда
      ...
      False = CLI-модус активирован [Стандарт]; True = CLI-модус деактивирован.
 ...
 - Конфигурация подписями.
   ...
   - Реакция phpMussel на отсутсвие подписей или дефект в них. Когда
     ...
     False = Деактивировано; True = Активировано [Стандарт].
 ...
 - Файл обработки конфигурации.
   ...
   - Обработка файлов, превышающих ограничение объёма файлов (если указано).
     False = Добавить к белому списку;
     True = Добавить к чёрному списку [Стандарт].
   ...
   - Нужно ли проверять содержимое архивов?
     False = Нет (никакой проверки); True = Да (будет проверяться) [Стандарт].
   ...
   - Должен ли объём файла чёрного/белого списка быть перенесён на содержание
     архива? False = Нет (всё поместить в серый лист); True = Да [Стандарт].
   "filetype_archives"
   - Должен ли тип файла чёрного/белого списка быть перенесён на содержание
     архива? False = Нет (всё поместить в серый лист) [Стандарт]; True = Да.
   "max_recursion"
 ...
 - Атака конкретных директив.
   * Определение хамелеон-атаки: False = Деактивировано; True = Активировано.
   ...
   - Должнó ли содержание файлов проверяться на общие команды, как "eval()",
     "exec()" и "include"?
     False = Нет (не проверять) [Стандарт]; True = Да (проверять).
   ...
   - Должны ли файлы, содержащие командные сигналы (отличные от Newline/конец
     ...
     False = Не блокировать [Стандарт]; True = Блокировать.
   "corrupted_exe"
   - Дефектные файлы и разобрать ошибки.
     False = Игнорировать; True = Блокировать [Стандарт]. Должны ли
     потенциально дефектные файлы при загрузке проверяться и блокироваться? В
     случае когда определённые аспекты PE-файла повреждены или могут быть
     неправильно обработаны, то часто (однако не всегда) они идентифицируются
     как инфицированные файлы. Многие антивирусные программы используют
     различные методы по опознанию вирусов в таких файлах. Программисты
     вирусов, зная об этом, прилагают много усилий к тому, чтобы вирус остался
     неопознанным.
   "decode_threshold"
 ...
 - Директивы совместимости для phpMussel.
   ...
   - Как правило, эта директива находится в положении False/Деактивировано,
     если только нет потребности в ней для правильного функционирования
     phpMussel на вашей системе. При находящейся в положении
     False/Деактивировано директиве phpMussel, опознав нѐкий элемент в $_FILES
     array(), начинает проверять файлы, представляющие этот элемент. В случае
     если файлы окажутся пустыми, phpMussel подаёт сигнал тревоги. Это
     нормальная реакция phpMussel. Однако некоторые CMS нормальными считают
     пустые элементы в $_FILES, и сигнал тревоги подаётся в случае отсутствия
     пустых элементов. В этой ситуации возникает конфликт между нормальным
     поведением phpMussel и CMS. Если это касается вашей CMS, то вам необходимо
     переключить опцию в позицию True/Активировано, тогда phpMussel не будет
     ...
     False = Деактивировано; True = Активировано.
   "only_allow_images"
 ...
 = КОДИРОВАНИЕ ПОДПИСЕЙ =
   ...
   - «Email подписи» (mail_*). Посредством функционирования phpMussel_mail()
      проверяются переменные $body сообщений или похожих записей (на форумах
      и т.д.).
   ...
   - «PE расширенного подписей» (pex_*). Посредством значений и MD5-Hash и
      объём переменных в каждого файла, не внесённый в белый список и которые
      следует проверить, а также его соответствие PE-формату.
   ...
   - «XML/XDP подписи» (xmlxdp_*). Поверяются группы XML/XDP файлов из каждого
      файла, не внесённого в белый список и которые следует проверить.
 ...
 Последний раз эта информация обновлялась 2015.12.12 года и считается
 актуальной для всех опубликованных на данный момент phpMussel и обеих её
 дополнительных версий (v0.8-v0.9.0).
 ...
 Bkav                 !  Сообщает "VEXD737.Webshell"
 ...
 Cyren                !  Сообщает "W32/GenBl.DE4CF18E!Olympus"
...
Последнее обновление: 4 Февраль 2016 (2016.02.04).
EOF