...
6) На этом инсталляционный процесс заканчивается. Теперь Вам необходимо протестировать программу на правильность функционирования. Для этого Вам нужно имеющиеся в пакете тестовые файлы `_testfiles` загрузить на Вашу веб-страницу любым способом, который позволяет Ваш браузер. При нормальном функционировании программы появится сообщение от phpMussel, что загрузка (Upload) была успешно блокирована. Если такое сообщение не появилось, то программа функционирует неправильно. Воспользуйтесь другими расширенными функциями или всевозможными сканированными видами этой программы. Вы должны тестировать до тех пор, пока не убедитесь в нормальном функционировании программы.
...
"detect_adware"
- Should phpMussel parse signatures for detecting adware? 0 = Нет; 1 = Да [Стандарт].

"detect_joke_hoax"
- Should phpMussel parse signatures for detecting joke/hoax malware/viruses? 0 = Нет; 1 = Да [Стандарт].

"detect_pua_pup"
- Should phpMussel parse signatures for detecting PUAs/PUPs? 0 = Нет; 1 = Да [Стандарт].

"detect_packer_packed"
- Should phpMussel parse signatures for detecting packers and packed data? 0 = Нет; 1 = Да [Стандарт].

"detect_shell"
- Should phpMussel parse signatures for detecting shell scripts? 0 = Нет; 1 = Да [Стандарт].

"detect_deface"
- Should phpMussel parse signatures for detecting defacements and defacers? 0 = Нет; 1 = Да [Стандарт].
...
Последнее обновление: 14. Август 2015 (2015.08.14).
