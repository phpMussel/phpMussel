...
/_docs/readme.vi.md                        | Документация на вьетнамском язык: TIẾNG VIỆT
/_docs/readme.vi.txt                       | Документация на вьетнамском язык: TIẾNG VIỆT
/_docs/readme.zh.md                        | Документация на китайском язык: 中文（简体）
/_docs/readme.zh-TW.md                     | Документация на китайском язык: 中文（傳統）
...
- «Подписи белого списка» (whitelist_*). Посредством MD5-Hash проверяется содержание и объём каждого файла которые следует проверить. Matched files will be immune to being matched by the type of signature mentioned in their whitelist entry.
