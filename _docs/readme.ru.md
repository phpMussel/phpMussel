...
Последний раз эта информация обновлялась 2016.08.02 года и считается актуальной для всех опубликованных на данный момент phpMussel и обеих её дополнительных версий (v0.10.0-v1.0.0).
...
Последнее обновление: 2 Август 2016 (2016.08.02).
