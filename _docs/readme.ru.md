...
- "Complex_Extended"
Скан с комплексом-расширенных-подписями? Если да, то указать имена файлов сигнатур для использования, через запятую.
...
Последнее обновление: 19 Февраль 2017 (2017.02.19).
