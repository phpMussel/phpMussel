...
Также большую благодарность выражаю SourceForge и GitHub за созданные ими хостадреса проектов; Подписчикам [SecuriteInfo.com](https://www.securiteinfo.com/), [PhishTank](https://www.phishtank.com/), [NLNetLabs](https://nlnetlabs.nl/) и другим. Особая благодарность тем, кто поддержит этот проект, а также всем неназванным мною людям, в том чисте и Вам за то, что пользуетесь этим пособием.
...
Эта информация относится к самой последней версии v1.x.x, и может не иметь отношения к другим версиям или выпускам.
...
Последнее обновление: 29 Январь 2019 (2019.01.29).
