...
update
- Необходимый пароль: `script_password`
- Следующие условия: должны быть в наличии `update.dat` и `update.php`.
- Необходимые параметры: (нет)
- Дополнительные параметры: (нет)
...
/Changelog-v0.txt | Перечень внесённых в руководство изменений и его различные версии (на эффективность данного руководства не влияет).
...
/vault/update.php | Обновление данного руководства; будет использоваться только для автоматической актуализации и вручную при посредничестве браузера.
...
Последнее обновление: 18 Март 2016 (2016.03.18).
