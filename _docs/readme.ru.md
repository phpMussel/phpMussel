...
Тем не менее у Вас есть возможность отдать распоряжение phpMussel сканировать файлы, папки или архивы, указанные Вами неявно. Для этого убедитесь, что данная структура имеет формат `phpmussel.ini` (cleanup должен быть деактивирован), Создайте PHP-файл, интегрированный в phpMussel, со следующей функцией:
...
Файл                                       | Описание
-------------------------------------------|--------------------------------------
/phpmussel.php                             | Загружаемый файл. Скачивает руководство, Updater и т.д. Этот файл будет связан с Вашей системой управления содержимым (CMS) (обязательно!).
...
/_docs/readme.de.md                        | Документация на немецком языке: DEUTSCH
/_docs/readme.de.txt                       | Документация на немецком языке: DEUTSCH
/_docs/readme.en.md                        | Документация на английском языке: ENGLISH
/_docs/readme.en.txt                       | Документация на английском языке: ENGLISH
/_docs/readme.es.md                        | Документация на испанском языке: ESPAÑOL
/_docs/readme.es.txt                       | Документация на испанском языке: ESPAÑOL
/_docs/readme.fr.md                        | Документация на французском языке: FRANÇAIS
/_docs/readme.fr.txt                       | Документация на французском языке: FRANÇAIS
/_docs/readme.id.md                        | Документация на индонезийском языке: BAHASA INDONESIA
/_docs/readme.id.txt                       | Документация на индонезийском языке: BAHASA INDONESIA
/_docs/readme.it.md                        | Документация на итальянском языке: ITALIANO
/_docs/readme.it.txt                       | Документация на итальянском языке: ITALIANO
/_docs/readme.nl.md                        | Документация на нидерланском языке: NEDERLANDSE
/_docs/readme.nl.txt                       | Документация на нидерланском языке: NEDERLANDSE
/_docs/readme.pt.md                        | Документация на португальском языке: PORTUGUÊS
/_docs/readme.pt.txt                       | Документация на португальском языке: PORTUGUÊS
/_docs/readme.ru.md                        | Документация на русском языке: РУССКИЙ
...
/vault/ascii_mussel_regex.cvd              | Файл с нормированных ASCII подписями.
...
/vault/mail_clamav_standard.map            | Файл с подписями для phpMussel_mail() подписями.
...
/vault/xmlxdp_clamav_standard.cvd          | Файл с группы XML/XDP подписями.
...
"cleanup"
- После исполнения стирает переменные величины данного руководства и очищает кэш-память. Если вы не хотите пользоваться руководством после того, как проверили загрузку программы, то установите опцию «да» ("yes"), чтобы минимизировать загрузку памяти. Если вы будете использовать руководство и для других целей, то установите опцию «нет» ("no"), дабы избежать ненужного многократного считывания данных в памяти. Как правило, устанавливается опция «да» ("yes"), но потом Вы сможете пользоваться руководством только для контроля файлов.
- Не воздействует на CLI-модус.
...
"delete_on_sight"
- Эта опция позволяет в течение сканирования немедленно удалять файлы при наличии в них опознавательных признаков, содержащихся в подписи или других методах. При этом не будут затрагиваться файлы, идентифицированные как неинфицированные. Если в архиве будет инфицирован хотя бы один файл, то будет удалён весь архив. Во время загрузки файлов эту функцию активировать не обязательно, так как PHP после исполнения удаляет содержимое кэш-памяти. Это означает, что PHP удалит каждый скаченный через сервер файл, если он не перемещён, не скопирован или не удалён. Эта опция, как дополнительная мера, была введена для большей безопасности, но в основном для систем, в которых PHP ведёт себя по-другому. 0 – После проверки файл останется нетронутым [Стандарт]; 1 – После проверки инфицированный файл будет немедленно удалён.
...
Скан с MD5-подписями? 0 = Нет; 1 = Да [Стандарт].
- "md5_clamav"
- "md5_custom"
- "md5_mussel"

Скан с генеральными подписями? 0 = Нет; 1 = Да [Стандарт].
- "general_clamav"
- "general_custom"
- "general_mussel"

Скан с нормированными ASCII подписями? 0 = Нет; 1 = Да [Стандарт].
- "ascii_clamav"
- "ascii_custom"
- "ascii_mussel"

Скан с нормированными HTML подписями? 0 = Нет; 1 = Да [Стандарт].
- "html_clamav"
- "html_custom"
- "html_mussel"

Скан PE-файлов (Portable Executable, EXE, DLL и др.) с PE-секционными подписями? 0 = Нет; 1 = Да [Стандарт].
- "pe_clamav"
- "pe_custom"
- "pe_mussel"

Скан PE-файлов (Portable Executable, EXE, DLL и др.) с PE расширенного опознавания подписями? 0 = Нет; 1 = Да [Стандарт].
- "pex_custom"
- "pex_mussel"

Скан PE-файлов (Portable Executable, EXE, DLL и др.) с PE-подписями? 0 = Нет; 1 = Да [Стандарт].
- "exe_clamav"
- "exe_custom"
- "exe_mussel"

Скан ELF-файлов с ELF-подписями? 0 = Нет; 1 = Да [Стандарт].
- "elf_clamav"
- "elf_custom"
- "elf_mussel"

Скан Mach-O-файлов (OSX и др.) с Mach-O-подписями? 0 = Нет; 1 = Да [Стандарт].
- "macho_clamav"
- "macho_custom"
- "macho_mussel"

Скан графических файлов с графическими подписями? 0 = Нет; 1 = Да [Стандарт].
- "graphics_clamav"
- "graphics_custom"
- "graphics_mussel"

Скан содержания архива с метаданными подписями? 0 = Нет; 1 = Да [Стандарт].
- "metadata_clamav"
- "metadata_custom"
- "metadata_mussel"

Скан OLE-объектов с OLE-подписями? 0 = Нет; 1 = Да [Стандарт].
- "ole_clamav"
- "ole_custom"
- "ole_mussel"

Скан названий файлов с их подписями? 0 = Нет; 1 = Да [Стандарт].
- "filenames_clamav"
- "filenames_custom"
- "filenames_mussel"

Скан с позволенными phpMussel_mail()? 0 = Нет; 1 = Да [Стандарт].
- "mail_clamav"
- "mail_custom"
- "mail_mussel"

Активировать особый файл «белый список»? 0 = Нет; 1 = Да [Стандарт].
- "whitelist_clamav"
- "whitelist_custom"
- "whitelist_mussel"

Скан группы XML/XDP данных с их подписями? 0 = Нет; 1 = Да [Стандарт].
- "xmlxdp_clamav"
- "xmlxdp_custom"
- "xmlxdp_mussel"

Скан с комплексом-расширенных-подписями? 0 = Нет; 1 = Да [Стандарт].
- "coex_clamav"
- "coex_custom"
- "coex_mussel"

Скан с PDF-подписями? 0 = Нет; 1 = Да [Стандарт].
- "pdf_clamav"
- "pdf_custom"
- "pdf_mussel"

Скан с Shockwave-подписями? 0 = Нет; 1 = Да [Стандарт].
- "swf_clamav"
- "swf_custom"
- "swf_mussel"
...
"detect_adware"
- Интерпретировать подписей для обнаружить рекламное программное? 0 = Нет; 1 = Да [Стандарт].

"detect_joke_hoax"
- Интерпретировать подписей для обнаружить шутка вредоносные/вирусы программы? 0 = Нет; 1 = Да [Стандарт].

"detect_pua_pup"
- Интерпретировать подписей для обнаружить PUAs/PUPs (потенциально нежелательных программы/приложений)? 0 = Нет; 1 = Да [Стандарт].

"detect_packer_packed"
- Интерпретировать подписей для обнаружить упаковщики и упакованные данные? 0 = Нет; 1 = Да [Стандарт].

"detect_shell"
- Интерпретировать подписей для обнаружить веб-шелл скрипты? 0 = Нет; 1 = Да [Стандарт].

"detect_deface"
- Интерпретировать подписей для обнаружить дифейсмент/обезображивание программы? 0 = Нет; 1 = Да [Стандарт].
...
Последний раз эта информация обновлялась 28.05.2015 года и считается актуальной для всех опубликованных на данный момент phpMussel и обеих её дополнительных версий (v0.5-v0.6i).
...
| Symantec             |  Сообщает "WS.Reputation.1"          |
