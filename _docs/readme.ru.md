...
Последний раз эта информация обновлялась 2015.09.07 года и считается актуальной для всех опубликованных на данный момент phpMussel и обеих её дополнительных версий (v0.6-v0.7a).
...
Последнее обновление: 7. Сентябрь 2015 (2015.09.07).
