...
/LICENSE.txt | Копия лицензии GNU/GPLv2.
...
/vault/cli.inc | Обработчик CLI (Способ Командных Строк).
/vault/config.inc | Обработчик конфигурации.
/vault/controls.inc | Обработчик контроль.
/vault/functions.inc | Функции файла (обязательно).
...
/vault/upload.inc | Обработчик загрузить.
...
Последнее обновление: 11 Март 2016 (2016.03.11).
