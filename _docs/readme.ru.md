...
/vault/core.dat | Содержит информацию, относящуюся к основными компонентами phpMussel; Используется из функцией Обновления, предоставленной из фронтенд.
...
/vault/l10n.dat | Содержит информацию, относящуюся к L10N компонентами phpMussel; Используется из функцией Обновления, предоставленной из фронтенд.
