...
- 4. [УПРАВЛЕНИЕ FRONT-END](#SECTION4)
...
Информация по деактивированию содержащихся в phpMussel подписей находится в указаниях к серым спискам (Greylisting) в разделе УПРАВЛЕНИЕ FRONT-END.
...
###4. <a name="SECTION4"></a>УПРАВЛЕНИЕ FRONT-END
...
"disable_frontend"
- Деактивировать доступ к front-end? Доступ к front-end может сделать phpMussel более управляемым, но также может быть потенциальный риск безопасности. Рекомендуется чтобы управлять phpMussel через back-end когда возможно, но доступ к front-end предоставлен для того когда это не возможно. Держите его деактивирована за исключением того если вам это нужно. False = Активировать доступ к front-end; True = Деактивировать доступ к front-end [Стандарт].
...
Последнее обновление: 16 Октябрь 2016 (2016.10.16).
