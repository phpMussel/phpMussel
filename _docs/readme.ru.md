...
/vault/urlscanner.cvd                      | Файл с URL сканер подписями.
...
Последний раз эта информация обновлялась 2015.12.12 года и считается актуальной для всех опубликованных на данный момент phpMussel и обеих её дополнительных версий (v0.8-v0.9.0).
