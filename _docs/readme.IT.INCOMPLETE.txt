 ...
 Spero di semplificare questo processo via un installatore ad un certo punto in
 un futuro non troppo lontano, ma fino ad allora, seguire queste istruzioni per
 avere phpMussel funzionale sulla maggior parte dei sistemi e CMS:
 ...
 Please refer to the "COME INSTALLARE (PER CLI)" section of this readme file.
 ...
 as of the latest version of phpMussel. Refer to the "COME INSTALLARE (PER CLI)"
