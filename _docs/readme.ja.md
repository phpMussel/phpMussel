...
###4A. <a name="SECTION4"></a>ブラウザ・コマンド
...
###4B. <a name="SECTION5"></a>CLI （コマンドライン・インターフェイス）
...
###5. <a name="SECTION6"></a>本パッケージに含まれるファイル
...
###7. <a name="SECTION8"></a>署名（シグニチャ）フォーマット
