...
Questa informazione è stato lo scorso aggiornato 7 Settembre 2015 ed è in corso per tutte le phpMussel rilasci delle due più recenti minori versioni (v0.6-v0.7a) al momento di scrivere questo.
