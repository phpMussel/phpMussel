...
- 4A. [BROWSER COMANDI](#SECTION4A) @DEPRECATED@
...
/vault/config.ini | File di configurazione; Contiene tutte l'opzioni di configurazione per phpMussel, dicendogli cosa fare e come operare correttamente (essenziale)!
