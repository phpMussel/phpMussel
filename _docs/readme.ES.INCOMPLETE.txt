 ...
 <   |_____] |_____| |_____] |  |  | |     | |______ |______ |______ |        >
     |       |     | |       |  |  | |_____| ______| ______| |______ |_____    
                            ...
                            { ~ ~ ~ ESPAÑOL ~ ~ ~ }                            
 Gracias por usar phpMussel, un PHP script basado en las definiciones de ClamAV
    diseñados para detectar troyanos, virus, malware y otras amenazas en los   
         archivos cargados en el sistema donde el script está adjunto.         
   PHPMUSSEL COPYRIGHT 2013 después de eso GNU/GPL V.2 by Caleb M (Maikuolan)  
 ...
 * Filename may differ based on configuration stipulations (in phpmussel.ini).
 ...
 Ikarus               !  Informes "Trojan.JS.Agent" (v0.3g sólo)
...
Última Actualización: 11 Junio 2014
EOF