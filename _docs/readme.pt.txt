 ...
 /_docs/change_log.txt (Documentação, Incluído)
    ...
    ~
 /_docs/readme.ar.md (Documentação, Incluído); Árabe
 /_docs/readme.de.md (Documentação, Incluído); Alemão
 /_docs/readme.de.txt (Documentação, Incluído); Alemão
 /_docs/readme.en.md (Documentação, Incluído); Inglês
 /_docs/readme.en.txt (Documentação, Incluído); Inglês
 /_docs/readme.es.md (Documentação, Incluído); Espanhol
 /_docs/readme.es.txt (Documentação, Incluído); Espanhol
 /_docs/readme.fr.md (Documentação, Incluído); Francesa
 /_docs/readme.fr.txt (Documentação, Incluído); Francesa
 /_docs/readme.id.md (Documentação, Incluído); Indonésio
 /_docs/readme.id.txt (Documentação, Incluído); Indonésio
 /_docs/readme.it.md (Documentação, Incluído); Italiano
 /_docs/readme.it.txt (Documentação, Incluído); Italiano
 /_docs/readme.nl.md (Documentação, Incluído); Holandês
 /_docs/readme.nl.txt (Documentação, Incluído); Holandês
 /_docs/readme.pt.md (Documentação, Incluído); Português
 /_docs/readme.pt.txt (Documentação, Incluído); Português
 /_docs/readme.ru.md (Documentação, Incluído); Russo
 /_docs/readme.ru.txt (Documentação, Incluído); Russo
 /_docs/readme.vi.md (Documentação, Incluído); Vietnamita
 /_docs/readme.vi.txt (Documentação, Incluído); Vietnamita
 /_docs/readme.zh.md (Documentação, Incluído); Chinês (Simplificado)
 /_docs/readme.zh-TW.md (Documentação, Incluído); Chinês (Tradicional)
 ...
 /_testfiles/xdp_standard_testfile.xdp (Test file, Incluído)
    Teste arquivo para testar phpMussel XML/XDP assinaturas.
    ~
 /vault/ (Diretório)
 ...
 /vault/lang/.htaccess (Outro, Incluído)
    ...
    autorizadas).
    ~
 /vault/lang/lang.ar.inc (Script, Incluído); Árabe
 /vault/lang/lang.de.inc (Script, Incluído); Alemão
 /vault/lang/lang.en.inc (Script, Incluído); Inglês
 /vault/lang/lang.es.inc (Script, Incluído); Espanhol
 /vault/lang/lang.fr.inc (Script, Incluído); Francesa
 /vault/lang/lang.id.inc (Script, Incluído); Indonésio
 /vault/lang/lang.it.inc (Script, Incluído); Italiano
 /vault/lang/lang.ja.inc (Script, Incluído); Japonês
 /vault/lang/lang.nl.inc (Script, Incluído); Holandês
 /vault/lang/lang.pt.inc (Script, Incluído); Português
 /vault/lang/lang.ru.inc (Script, Incluído); Russo
 /vault/lang/lang.vi.inc (Script, Incluído); Vietnamita
 /vault/lang/lang.zh.inc (Script, Incluído); Chinês (Simplificado)
 /vault/lang/lang.zh-TW.inc (Script, Incluído); Chinês (Tradicional)
 ...
 /vault/scan_log.txt *(Logfile, Criado)
    ...
    ~
 /vault/scan_log_serialized.txt *(Logfile, Criado)
    Um registro de tudo analisado por phpMussel.
    ~
 ...
 /vault/xmlxdp_mussel_standard.cvd (Assinaturas, Incluídos)
    Arquivos por XML/XDP assinaturas. Necessário se XML/XDP assinaturas opção
    em "phpmussel.ini" está ativado. Pode remover se a opção é desativado.
    ~
 ...
 * Arquivo nome podem variar baseado em configuração estipulação
 ...
 - Geral configuração por phpMussel.
    ...
    - Deletar script variáveis e cache após a execução?
      ...
      * Não tem influência em CLI modo.
    "scan_log"
    - Nome do arquivo para registrar todos os resultados do análises.
      Especifique um arquivo nome, ou deixe branco para desativar.
    "scan_log_serialized"
    - Nome do arquivo para registrar todos os resultados do análises (formato é
      serializado). Especifique um arquivo nome, ou deixe branco para
      desativar.
    "scan_kills"
    - Nome do arquivo para registrar todos os bloqueados ou matados
      carregamentos. Especifique um arquivo nome, ou deixe branco para
      desativar.
    "ipaddr"
    ...
    - Deve phpMussel enviar 403 header com a bloqueado arquivo carregamento
      ...
      False = Não (200) [Padrão]; True = Sim (403).
    "delete_on_sight"
    ...
    - Desativar o CLI modo? CLI modo é ativado por padrão, mas às vezes pode
      ...
      False = Ativar o CLI modo [Padrão]; True = Desativar o CLI modo.
 ...
 - Configuração por assinaturas.
   ...
   - Ativar arquivo-específico whitelist? False = Não; True = Sim [Padrão].
     ...
     "whitelist_custom"
     "whitelist_mussel"
   - Verificar XML/XDP pedaços contra XML/XDP assinaturas quando analisando?
     False = Não; True = Sim [Padrão].
     "xmlxdp_clamav"
     "xmlxdp_custom"
     "xmlxdp_mussel"
   ...
   - Deve phpMussel reportar quando os assinaturas arquivos estão perdido ou
     ...
     semelhantes problemas. False = Desativado; True = Ativado [Padrão].
   ...
   - Deve phpMussel reportar quando extensões não estão disponíveis? Se
     ...
     aumento de falsos positivos. False = Desativado; True = Ativado [Padrão].
   "detect_adware"
 ...
 - Geral configuração por a manipulação de arquivos.
   ...
   - Que fazer com arquivos que excedam o limite de arquivo tamanho (se
     existir). False = Whitelist; True = Blacklist [Padrão].
   ...
   "check_archives"
   - Tentativa de verificar os conteúdos dos compactados arquivos?
     False = Não (Não verificar); True = Sim (Verificar) [Padrão].
   ...
   - Herdar o arquivo tamanho blacklist/whitelist para o conteúdo de
     compactados arquivos? False = Não (greylist tudo); True = Sim [Padrão].
   "filetype_archives"
   - Herdar o arquivo tipo blacklist/whitelist para o conteúdo de compactados
     arquivos? False = Não (greylist tudo); True = Sim [Padrão].
   "max_recursion"
   ...
   - Detectar e bloquear compactados arquivos criptografados? Porque phpMussel
     ...
     essas tais possibilidades. False = Não; True = Sim [Padrão].
 ...
 - Configuração por específicas ataque detecções (não baseado em CVDs).
   * Chameleon ataque detecções: False = Inativo; True = Ativo.
   "chameleon_from_php"
   - Olha por PHP header em arquivos que são não PHP arquivos nem reconhecidos
   ...
   - Olha por compactados arquivos cujos headers estão incorretas (Suportados:
     BZ, GZ, RAR, ZIP, RAR, GZ).
   "chameleon_to_doc"
   - Olha por office documentos cujos headers estão incorretas (Suportados:
   ...
   - Bloquear todos os arquivos que contenham quaisquer caracteres de controle
     ...
     resultas em falso positivos.
     False = Não bloquear [Padrão]; True = Bloquear.
   "corrupted_exe"
   - Corrompidos arquivos e erros de análise.
     False = Ignorar; True = Bloquear [Padrão]. Detectar e bloquear
     potencialmente corrompidos PE (Portátil Executável) arquivos?
     Frequentemente (mas não sempre), quando certos aspectos de um PE arquivo é
     corrompido ou não pode ser analisado corretamente, essa pode ser
     indicativo de uma viral infecção. Os processos utilizados pela maioria dos
     anti-vírus programas para detectar vírus em PE arquivos requerem
     analisando os arquivos de certas maneiras, que, se o programador de um
     vírus é consciente de, especificamente irá tentar impedir, a fim de
     permitir seu vírus para permanecer não detectado.
   "decode_threshold"
 ...
 - Compatibilidade directivas por phpMussel.
   ...
   - Essa directiva deve ser geralmente desativada a menos que seja necessário
     ...
     página carga. False = DESATIVADO; True = ATIVADO.
   "only_allow_images"
 ...
 = ASSINATURA COMPOSIÇÃO =
   ...
   - "XML/XDP Assinaturas" (xmlxdp_*). Verificado contra quaisquer XML/XDP
      pedaços encontrados dentro cada arquivo não no whitelist e alvo por
      analisando.
