...
<div dir="rtl">phpMussel ساتھ شامل دستخطوں کو غیر فعال کرنے کے لئے (جیسا کہ آپ کو آپ کے مقاصد عموما مین لائن سے ہٹایا نہیں کیا جانا چاہئے کہ ایک جھوٹی مثبت مخصوص سامنا کر رہے ہیں کے طور پر اگر)، گرینسٹسٹ کے دستخط کے ناموں کو شامل کریں (<code dir="ltr">/vault/greylist.csv</code>)، کاموں کی طرف سے الگ.<br /><br /></div>
...
<div dir="rtl">آخری تازہ کاری: 28 فروری 2018 (2018.02.28).</div>
