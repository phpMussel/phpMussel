...
这个信息最后更新2016年4月21日和是准确为至少phpMussel的两个最近次要版本（v0.10.0-v1.0.0）在这个现在时候的写作。
...
| BitDefender          |  无冲突 |
| Bkav                 |  报告 "VEXC640.Webshell"， "VEXD737.Webshell"， "VEX5824.Webshell"|
| ByteHero             |  无冲突 |
| CAT-QuickHeal        |  无冲突 |
| ClamAV               |  无冲突 |
| CMC                  |  无冲突 |
...
| nProtect             |  无冲突 |
| Panda                |  无冲突 |
| Qihoo-360            |  报告 "Script/Trojan.Script.393" |
| Rising               |  无冲突 |
| Sophos               |  无冲突 |
